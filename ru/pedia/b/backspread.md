...
Бэкспред — это опционная стратегия, в которой длинных опционов больше, чем коротких. Она рассчитана на сильное движение базового актива, при этом риск ограничен, если движение не произойдет.

## Структура

Бэкспреды строятся на коллах или путах:
- Бэкспред коллами: короткий 1 колл и длинные 2 колла с более высоким страйком.
- Бэкспред путами: короткий 1 пут и длинные 2 пута с более низким страйком.

Позиция часто открывается за небольшой дебет или кредит в зависимости от волатильности и сдвига волатильности по страйкам.

## Профиль выплат

- Ограниченный риск около страйка короткого опциона.
- Потенциально крупная прибыль при сильном движении в сторону длинных опционов.
- Временной распад может работать против позиции, если движение не происходит.

## Когда используют

Бэкспреды применяют, когда ожидают резкое направленное движение или рост волатильности. Часто их используют перед событиями, такими как отчеты о прибыли или публикации макроданных.

## Риски

Главный риск — цена закрытия возле страйка короткого опциона на экспирации, когда доминирует короткий опцион. Экспозиции по гамме и веге могут быть существенными, поэтому важны размер позиции и сценарный анализ.
