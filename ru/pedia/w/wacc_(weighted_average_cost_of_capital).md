...
where:
- \( Rf \) = Risk-free rate (e.g., the yield on 10-year Treasury bonds)
- \( \beta \) = Beta, a measure of the stock’s volatility relative to the market
...
- **Estimations and Assumptions**: The calculation relies heavily on estimates, such as the risk-free rate, market premium, and beta. Incorrect assumptions can lead to inaccurate WACC.
- **Static Measure**: WACC does not capture the dynamic nature of capital markets and may not reflect future changes in market conditions or company-specific risks.
- **Ignores Retained Earnings**: WACC calculations often overlook the cost linked to retained earnings, potentially understating the true cost of capital.

### Practical Applications

1. **Corporate Valuation**: Investment firms and analysts use WACC in conjunction with DCF models to determine the intrinsic value of a company. For instance, Goldman Sachs ( utilizes WACC in their valuation methodologies.
2. **Mergers and Acquisitions**: When conducting due diligence and determining the purchase price for acquisitions, firms like Morgan Stanley ( consider the target’s WACC to assess the cost of capital and potential returns.
3. **Investment Strategies**: Hedge funds and asset managers, such as Bridgewater Associates ( apply WACC to evaluate potential investments and compare the returns against the cost of capital.
