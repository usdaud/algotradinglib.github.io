...
## Key points
- Quotes must be firm for at least the minimum size set by regulation or exchange rules.
- A market maker cannot refuse to trade at its own quoted price within that size.
- The rule applies to both bid and ask quotes.
...
## Practical checklist
- Define the time horizon for Firm Quote Rule and the market context.
...
## Common pitfalls
- Treating Firm Quote Rule as a standalone signal instead of context.
