...
## Delivery timeline
- The exchange publishes the delivery schedule for each contract month.
- First notice day starts the period when delivery can be assigned.
- Last notice day ends the delivery period.
...
## Practical notes
- Volume often shifts to the next contract month before first notice day.
- Spread markets become more active as traders roll.
- Some contracts have different notice rules, so the schedule must be checked.

## Practical checklist
- Define the time horizon for First Notice Day (FND) and the market context.
...
## Common pitfalls
- Treating First Notice Day (FND) as a standalone signal instead of context.
