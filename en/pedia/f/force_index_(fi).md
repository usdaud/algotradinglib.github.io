...
- Rising values with rising price can confirm a trend.
- Divergence between price and force index can warn of a weakening move.
...
## Practical checklist
- Define the time horizon for Force Index (FI) and the market context.
...
## Common pitfalls
- Treating Force Index (FI) as a standalone signal instead of context.
