...
- **Net Income**: Total profit after all expenses have been deducted from revenue.

### 1.2 Balance Sheet
The balance sheet offers a snapshot of a company's financial position at a specific point in time. It includes the following sections:

- **Assets**: Resources owned by the company, such as cash, inventory, and property.
- **Liabilities**: Obligations the company owes to others, like loans and accounts payable.
- **Equity**: Shareholders' residual interest in the company after liabilities are deducted from assets.

### 1.3 Cash Flow Statement
The cash flow statement examines how cash moves into and out of a company. It is divided into three main parts:

- **Operating Activities**: Cash flows from regular business operations.
- **Investing Activities**: Cash flows from investments in assets and other businesses.
...
The P/E ratio evaluates a company's current share price relative to its per-share earnings. It is calculated as:
...
The DDM values a stock by using the predicted dividends and discounting them back to present value. The model is expressed as:

\[ \text{Intrinsic Value} = \frac{\text{Dividends per Share}}{(\text{Discount Rate} - \text{Dividend Growth Rate})} \]
...
Qualitative analysis involves evaluating non-quantifiable factors that affect a company's performance, such as:

### 4.1 Management Quality
Assessing the leadership and management team is critical for understanding a company's future prospects. Important aspects include:

- **Experience and Track Record**: The management team's history in the industry.
- **Corporate Governance**: Policies and practices that ensure accountability and protect shareholders' interests.

### 4.2 Competitive Advantage
A company's ability to maintain a competitive edge is crucial for long-term success. Factors include:

- **Brand Strength**: Recognition and customer loyalty.
- **Intellectual Property**: Patents, trademarks, and proprietary technology.

### 4.3 Business Model
Understanding a company's business model helps to evaluate its potential for generating revenue and profit. Key aspects include:
