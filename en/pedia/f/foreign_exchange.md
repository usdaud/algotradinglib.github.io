...
A [stop-loss order](../s/stop-loss_order.md) automatically closes a [trade](../t/trade.md) when the price reaches a predetermined level, limiting potential losses. It's a crucial tool for managing [risk](../r/risk.md).
