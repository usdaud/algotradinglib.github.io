...
1. **Bid-Ask Spreads and Liquidity**: The realised transaction costs and market impact must be accounted for when entering and exiting variance swap positions.
...
4. **Volatility Jump and Clustering**: Realized volatility can experience jumps or exhibit clustering, requiring advanced models like stochastic volatility models or regime-switching models.
...
4. **Step 4**: Use Monte Carlo simulation to model future price paths and compute the expected realized variance.
