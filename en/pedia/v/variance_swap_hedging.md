...
- **Computational Models**:
 - Sophisticated algorithms and models are employed to predict and [hedge](../h/hedge.md) against movements in the [underlying](../u/underlying.md) variance. Firms like AQR Capital Management or Two Sigma utilize [quantitative models](../q/quantitative_models.md) extensively to manage these risks.
