...
Using options and [futures contracts](../f/futures_contracts.md) can protect against adverse price movements. For instance, a trader might use a put option to hedge against a potential decline in a stock's price.
...
Implementing strict [risk management](../r/risk_management.md) rules can prevent significant losses and reduce variance. This includes setting [stop-loss orders](../s/stop-loss_orders.md), [position sizing](../p/position_sizing.md), and leverage control.
...
Advanced statistical methods like Monte Carlo simulations, bootstrap methods, and [Bayesian inference](../b/bayesian_inference.md) can also be employed to reduce variance.
