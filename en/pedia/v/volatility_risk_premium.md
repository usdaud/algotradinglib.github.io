...
- [A study by Henderson et al. (2014)](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2169215) demonstrates that selling [options](../o/options.md) systematically generates positive returns due to the persistent VRP.
- [The Cboe Volatility Index (VIX)](https://www.cboe.com/tradable_products/vix/) is often used as a gauge for [market](../m/market.md) [volatility](../v/volatility.md) expectations, and studying its behavior has shown consistent patterns where implied [volatility](../v/volatility.md) exceeds [realized volatility](../r/realized_volatility.md), affirming the presence of VRP.
