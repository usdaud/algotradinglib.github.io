...
Firm’s algorithms need to execute trades with minimal latency. [Vertical integration](../v/vertical_integration.md) might involve owning or controlling the trading platforms and connectivity infrastructure to ensure ultra-low-latency execution. Some firms might go as far as colocating their servers within exchange data centers to gain milliseconds of advantage.
