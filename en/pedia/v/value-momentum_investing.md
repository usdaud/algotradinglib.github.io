...
- **[Earnings Yield](../e/earnings_yield.md)**: Inverse of the P/E ratio, helpful for comparing returns from equity investments to fixed-income investments.
...
- **Moving Averages (MA)**: These are used to smooth out price data to identify the direction of the trend.
- **Rate of Change (ROC)**: A momentum oscillator that measures the percentage change in price over a given time period.
...
1. **Screen for Value Stocks**: Use [fundamental analysis](../f/fundamental_analysis.md) tools to identify stocks that are undervalued based on traditional metrics like P/E ratio, P/B ratio, and [Earnings Yield](../e/earnings_yield.md).
2. **Analyze Momentum**: Evaluate the momentum of these value stocks using [technical indicators](../t/technical_indicators.md) like RSI, Moving Averages, and ROC.
...
5. **Rebalancing**: Regularly monitor the portfolio to ensure that the selected stocks still meet the criteria of being undervalued and having [positive momentum](../p/positive_momentum.md). Rebalance the portfolio periodically to adjust for any changes in market conditions or company fundamentals.

#### Benefits of Value-Momentum Investing

1. **[Risk Management](../r/risk_management.md)**: By integrating value and momentum, this strategy mitigates the risks associated with relying solely on one method.
...
1. **Execution Complexity**: Implementing a value-momentum strategy requires expertise in both fundamental and [technical analysis](../t/technical_analysis.md), making it relatively complex.
...
1. **AQR Capital Management**: AQR integrates value and momentum strategies extensively in their [portfolio management](../p/portfolio_management.md). More about AQR can be found on their website: [AQR Capital Management](https://www.aqr.com/).

2. **Bridgewater Associates**: While primarily quant-driven, Bridgewater employs diversified strategies that include elements of both value and momentum investing. Learn more about Bridgewater Associates on their website: [Bridgewater Associates](https://www.bridgewater.com/).

3. **Robeco**: This firm has various funds that apply the value-momentum strategy. Detailed information can be found here: [Robeco](https://www.robeco.com/).
...
3. **"Returns to Buying Winners and Selling Losers: Implications for Stock [Market Efficiency](../m/market_efficiency.md)" by Narasimhan Jegadeesh and Sheridan Titman**: This paper examines the profitability of momentum strategies.
