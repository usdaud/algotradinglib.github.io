...
1. **Point 1:** The highest high in an existing [uptrend](../u/uptrend.md).
2. **Point 2:** A reaction low after Point 1, representing initial resistance and a potential [pivot point](../p/pivot_point.md).
3. **Point 3:** A secondary high lower than Point 1, indicating weakness and the formation of a potential [double top](../d/double_top.md) or similar pattern.

### Formation Process
1. **[Uptrend](../u/uptrend.md) Phase:** The [market](../m/market.md) is in an upward trajectory, establishing higher highs and higher lows.
2. **Peak (Point 1):** The price hits a new high, forming the first pivot.
3. **[Retracement](../r/retracement.md) (Stage 2):** A [pullback](../p/pullback.md) occurs, leading the price to fall and create a lower pivot at Point 2.
...
### Entry Points
Traders typically enter short positions after the price breaks below the support level at Point 2, expecting further declines. Conservative traders might wait for a retest of the [breakout](../b/breakout.md) zone to confirm support turned resistance before entering.

### Stop-Loss Placement
Stops are generally placed above the most recent swing high before the breakdown, ensuring limited [risk](../r/risk.md) if the pattern fails.

### Target Levels
Traders often set initial targets by measuring the vertical distance from Point 1 to Point 2 and projecting it downwards from the [breakout](../b/breakout.md) level (Point 2).

### Risk Management
Proper [risk management](../r/risk_management.md) is crucial. Traders should use size limits, avoid excessive [leverage](../l/leverage.md), and maintain balance relative to their entire portfolio to mitigate risks associated with [false signals](../f/false_signals_in_trading.md) or [market](../m/market.md) [volatility](../v/volatility.md).
