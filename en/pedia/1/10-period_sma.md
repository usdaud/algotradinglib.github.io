...
- [QuantConnect](../q/quantconnect.md) is an [algorithmic trading](../a/algorithmic_trading.md) platform that supports extensive [backtesting](../b/backtesting.md) and [execution](../e/execution.md) of SMA-based strategies. (https://www.[quantconnect](../q/quantconnect.md).com/)
