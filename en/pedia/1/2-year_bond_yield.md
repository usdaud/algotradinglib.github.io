...
Prominent financial institutions and trading firms, such as Citadel Securities and Renaissance Technologies, use sophisticated algotrading strategies incorporating 2-year [bond](../b/bond.md) yields. These firms apply [machine learning](../m/machine_learning.md) and extensive historical data to enhance their [predictive models](../p/predictive_models_in_trading.md), thus ensuring more profitable trading decisions based on [yield](../y/yield.md) movements.
