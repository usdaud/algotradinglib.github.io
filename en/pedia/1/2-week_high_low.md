...
1. **[QuantConnect](../q/quantconnect.md):** QuantConnect offers a cloud-based platform to design, backtest, and execute algorithmic strategies in [multiple](../m/multiple.md) programming languages.
2. **[TradingView](../t/tradingview.md):** TradingView provides an easy-to-use interface for [technical analysis](../t/technical_analysis.md) and scripting custom [trading strategies](../t/trading_strategies.md) using Pine Script.
3. **MetaTrader:** MetaTrader supports [algorithmic trading](../a/algorithmic_trading.md) with its MQL4/MQL5 language for customized strategy scripts.
