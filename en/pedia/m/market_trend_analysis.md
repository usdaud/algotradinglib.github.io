...
A market trend refers to the perceived tendency of financial markets to move in a particular direction over time. These trends can be classified into three categories:

1. **Uptrend**: A series of higher highs and higher lows, indicating that the market is moving positively.
2. **Downtrend**: A series of lower highs and lower lows, suggesting that the market is in decline.
3. **Sideways/Horizontal Trend**: Prices move within a range without any significant upward or downward movement.

## Types of Trends By Duration

Market trends can also be classified by their duration:
...
**Moving Averages** are among the most commonly used tools for identifying market trends. They smooth out price data to create a single flowing line, which is easier to interpret. Commonly used moving averages include Simple Moving Averages (SMA) and Exponential Moving Averages (EMA).
...
The level of volume traded in a security can provide insights into the strength or weakness of a trend. Higher volumes are often considered stronger indicators of a trend.
...
A **contrarian strategy** is designed to go against prevailing market trends. It is based on the idea that, because the majority of investors are doing one thing, the opposite decision might be more profitable.
