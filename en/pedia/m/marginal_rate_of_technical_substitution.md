...
2. **Convex to the Origin**: Isoquants are typically convex to reflect the principle of diminishing marginal rates of technical substitution. This principle states that as you substitute one input for another, the substitutable rate decreases.
...
Where \( Q \) is the total output, \( K \) is capital, \( L \) is labor, \( A \) is a constant, and \( \alpha \) and \( \beta \) are the output elasticities of capital and labor, respectively.
