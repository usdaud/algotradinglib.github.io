...
## Types of momentum
- Time series momentum: trade the same asset based on its own past returns.
- Cross sectional momentum: rank assets and go long the winners and short the losers.
...
## Practical checklist
- Define the time horizon for Momentum Strategy and the market context.
...
## Common pitfalls
- Treating Momentum Strategy as a standalone signal instead of context.
