...
The SEC's Regulation NMS focuses on improving the fairness and efficiency of U.S. equity markets. It promotes competition in the execution of trades and seeks to ensure that investors receive the best possible price.
...
Implemented by the SEC and CFTC, the Dodd-Frank Act aims to reduce risk in the financial system. It includes provisions to regulate swaps, establishing clearing and trade execution requirements, and enhancing the oversight of previously unregulated markets.

### 4. Risk Management Requirements

#### 4.1. Pre-Trade Controls

To avoid disruptive trading actions, regulators mandate pre-trade risk controls. Firms must implement measures to scrutinize and control orders before they hit the market, ensuring they comply with regulatory limits.

#### 4.2. Post-Trade Monitoring

Post-trade monitoring involves assessing trading activities to detect anomalies or patterns indicative of market abuse or technical failures. Firms are required to keep detailed records and conduct regular audits.
...
Under MiFID II and Reg NMS, firms must report executed trades in near real-time. This transparency aids in price discovery and market integrity.
...
Regulatory bodies employ sophisticated surveillance technologies to monitor trading activities continuously. These systems can detect suspicious activities, such as spoofing, layering, and other forms of market manipulation.

#### 6.1. Enforcement Actions

When violations of market regulations are detected, regulatory bodies possess the authority to take enforcement action. This can range from fines and sanctions to criminal prosecutions, depending on the severity of the infractions.
...
Given the global nature of financial markets, international coordination among regulatory bodies is essential. Organizations like IOSCO (International Organization of Securities Commissions) are pivotal in fostering cooperative regulatory policies.
