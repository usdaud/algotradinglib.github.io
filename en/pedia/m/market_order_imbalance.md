...
## How it is observed
- High ratio of buyer initiated trades versus seller initiated trades.
- Large market orders entering a thin order book.
- Auction imbalances where market orders dominate the crossing process.
...
## Practical checklist
- Define the time horizon for Market Order Imbalance and the market context.
...
## Common pitfalls
- Treating Market Order Imbalance as a standalone signal instead of context.
