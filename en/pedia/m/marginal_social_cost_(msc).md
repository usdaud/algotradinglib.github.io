...
Marginal Social Cost (MSC) is a key concept in [economics](../e/economics.md) that represents the total cost to society of producing an additional unit of a good or service. It includes both the private cost incurred by producers and any external costs borne by third parties, which are often not reflected in the [market price](../m/market_price.md). Understanding MSC is crucial for evaluating the true cost and benefits of production and consumption activities, especially in the presence of externalities, such as pollution.
...
Understanding and calculating MSC helps policymakers in designing appropriate interventions to ensure that socially optimal levels of production and consumption are achieved. Without internalizing external costs, markets can [fail](../f/fail.md), leading to overproduction of goods with negative externalities and underproduction of goods with positive externalities.

### Economic Efficiency

In a perfectly competitive [market](../m/market.md) without externalities, the marginal private cost (MPC) equals the marginal social cost (MSC). However, when externalities are present, markets [fail](../f/fail.md) to achieve [economic efficiency](../e/economic_efficiency.md). For example:

- **Negative Externalities:** When firms do not account for the external costs of their activities (like pollution), the MSC is higher than the MPC. This leads to overproduction and consumption, causing [welfare](../w/welfare.md) losses.
...
Marginal Social Cost (MSC) is an essential concept in [economics](../e/economics.md), providing a comprehensive view of the true cost of production and consumption activities. By considering both private and external costs, MSC helps identify the extent of [market](../m/market.md) failures and guides policymakers in designing interventions to achieve social [welfare](../w/welfare.md) [optimization](../o/optimization.md). Accurate estimation and effective [internalization](../i/internalization.md) of externalities are vital for addressing pressing issues such as environmental degradation, public health, and urban congestion, ultimately leading to more sustainable and equitable economic outcomes.