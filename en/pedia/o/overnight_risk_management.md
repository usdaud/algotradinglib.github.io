...
Overnight risk, also known as gap risk, is the risk that the market price of a financial instrument will change drastically from its previous closing price when it reopens the next trading day. Because markets close for several hours, any significant news or events that occur during this period can lead to substantial price movements, creating the risk of large losses (or gains).
...
Adjusting the size of positions is an essential tactic for managing overnight risk. Instead of taking large positions that can expose the portfolio to considerable gaps, traders can reduce position sizes to limit exposure.

### 2. Hedging Strategies

Hedging involves taking offsetting positions to mitigate risk. For example, a trader might use derivative instruments such as options or futures to hedge against potential adverse price movements of the primary assets held.

### 3. Diversification

By diversifying the portfolio across various assets and asset classes, traders can spread the risk and reduce the impact of adverse price movements in a specific asset. Diversification ensures that not all assets are likely to be affected by the same overnight events.
...
Keeping track of major news events, economic data releases, and geopolitical developments helps anticipate market movements. Traders can adjust their positions accordingly before the markets close.
...
Some traders choose to partially liquidate their positions before the market closes to reduce exposure. This approach is a balance between fully exiting the market and maintaining full exposure.
