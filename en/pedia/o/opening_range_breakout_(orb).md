...
- Enter on a break of the range in the direction of the breakout.
- Place a stop on the opposite side of the range.
...
## Practical checklist
- Define the time horizon for Opening Range Breakout (ORB) and the market context.
...
## Common pitfalls
- Treating Opening Range Breakout (ORB) as a standalone signal instead of context.
