...
- **[Standard Deviation](../s/standard_deviation.md) ([Volatility](../v/volatility.md))**: Measures the amount of variation or [dispersion](../d/dispersion.md) of a set of values.
