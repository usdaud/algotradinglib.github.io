...
### Operating Leases
Operating leases are perhaps the most common form of off-[balance sheet](../b/balance_sheet.md) [financing](../f/financing.md). In an [operating lease](../o/operating_lease.md), the [lessee](../l/lessee.md) rents an [asset](../a/asset.md) but does not record it as an [asset](../a/asset.md) or [liability](../l/liability.md) on their [balance sheet](../b/balance_sheet.md). Rental expenses are recognized in the [income statement](../i/income_statement.md), and the [asset](../a/asset.md) remains on the lessor's [balance sheet](../b/balance_sheet.md). This differs from a [capital](../c/capital.md) lease, where the [lessee](../l/lessee.md) would record both the [asset](../a/asset.md) and [liability](../l/liability.md).

### Joint Ventures and Partnerships
Another way to keep liabilities off the [balance sheet](../b/balance_sheet.md) is through [joint](../j/joint.md) ventures and partnerships. These arrangements allow companies to share the risks and rewards of an investment without having to fully record the financial commitments associated with it.
...
With many cases of financial [fraud](../f/fraud.md) linked to off-[balance sheet](../b/balance_sheet.md) [financing](../f/financing.md), regulatory bodies like the [Financial Accounting](../f/financial_accounting.md) Standards Board (FASB) have laid down stricter guidelines. The introduction of standards such as IFRS 16 and ASC 842 have made it harder for companies to keep leasing [obligations](../o/obligation.md) off the [balance sheet](../b/balance_sheet.md). These standards require all leases to be recorded as assets and liabilities on the balance sheets, unless they meet certain short-term criteria.

### IFRS 16
The International Financial Reporting Standards (IFRS) 16, which became effective on January 1, 2019, significantly changed the way companies report leasing [obligations](../o/obligation.md). Under IFRS 16, lessees are required to recognize almost all leases on the [balance sheet](../b/balance_sheet.md), which brings more [transparency](../t/transparency.md) and consistency.
...
This ratio measures a company's financial [leverage](../l/leverage.md). By keeping liabilities off the [balance sheet](../b/balance_sheet.md), a [firm](../f/firm.md) can keep this ratio lower than it might be if all [obligations](../o/obligation.md) were recorded, making it appear less risky to investors.

### Earnings Before Interest, Taxes, Depreciation, and Amortization (EBITDA)
Since off-[balance sheet](../b/balance_sheet.md) [financing](../f/financing.md) reduces the number of liabilities recorded, it doesn't affect the EBITDA. This metric is often used by analysts and investors to assess a company's operational performance without regard to [financing](../f/financing.md) structure.
...
Improper use of OBSF can lead to poor financial management practices, as companies may take on more [risk](../r/risk.md) than they can [handle](../h/handle.md). This can lead to financial instability and potential [insolvency](../i/insolvency.md).

## Conclusion
Off-[Balance Sheet](../b/balance_sheet.md) [Financing](../f/financing.md) remains a controversial but important financial tool for companies looking to manage their balance sheets strategically. With evolving regulations and increased scrutiny, the practice has become more transparent, but it still holds various risks and rewards. Understanding OBSF, its instruments, and its impacts on financial metrics is crucial for analysts, investors, and corporate managers to make informed decisions.