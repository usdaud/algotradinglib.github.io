...
## History
Oslo Børs was founded in 1819 but only started trading domestic [shares](../s/shares.md) in 1881. Over the years, the [exchange](../e/exchange.md) has adapted to various technologies and regulations to better serve its [market](../m/market.md) participants.

### Key Milestones
- **1819:** Establishment of Oslo Børs.
- **1881:** Commencement of trading in domestic [shares](../s/shares.md).
- **1988:** Introduction of electronic [trading systems](../t/trading_systems.md).
- **2001:** Oslo Børs became a publicly [listed](../l/listed.md) company.
...
- **[Derivatives](../d/derivatives.md):** [Options](../o/options.md) and [futures](../f/futures.md).

### Regulatory Framework
The Oslo Stock [Exchange](../e/exchange.md) operates under the supervisory regime of the Financial Supervisory Authority of Norway (FSA). It adheres to both national and international regulations to ensure a transparent and efficient [market](../m/market.md).

## Listing Requirements
For companies to be [listed](../l/listed.md) on the OSL, they must meet specific criteria, including [financial performance](../f/financial_performance.md), governance standards, and public [disclosure](../d/disclosure.md) [obligations](../o/obligation.md). The listing process is designed to ensure only credible and financially sound companies can participate.

### Equity Listings
- **Minimum Share [Capital](../c/capital.md) Requirement:** NOK 10 million
...
- **[Operational Efficiency](../o/operational_efficiency_in_trading.md):** Improved trading [infrastructure](../i/infrastructure.md).
- **[Market](../m/market.md) Access:** Enhanced international reach for [listed](../l/listed.md) companies.
- **Regulatory Changes:** Alignment with broader [Euronext](../e/euronext.md) regulatory framework.
