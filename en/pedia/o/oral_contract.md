...
An oral contract, also known as a verbal contract, is an agreement between parties that is made verbally and not documented in writing. Despite the lack of written evidence, oral contracts are just as legally binding as written contracts in many cases. However, the enforceability of an oral contract can be challenging since proving the terms and existence of the agreement often depends on witness testimony or other forms of evidence.
...
In many jurisdictions, oral contracts are considered legally binding. However, proving the existence and specifics of the agreement can be significantly more challenging than with a written contract.
...
## Common Scenarios in Oral Contracts
...
Proving the existence and terms of an oral contract generally relies on:
...
1. **Proof Issues**: Difficulty in proving the contract's existence and terms.
2. **Ambiguity**: Greater potential for misunderstandings and disputes.
3. **Lack of Formal Record**: Harder to look back and verify exact terms later.
...
Consulting a legal professional can help ensure that any oral agreements are enforceable and address potential pitfalls.

### Clear Communication

Clearly articulate the terms, and ensure mutual understanding to avoid future disputes.
