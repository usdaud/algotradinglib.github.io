...
1. **[QuantConnect](../q/quantconnect.md)**: QuantConnect offers an [algorithmic trading](../a/algorithmic_trading.md) platform that emphasizes rigorous [backtesting](../b/backtesting.md) and out-of-sample performance evaluation.
...
3. **WorldQuant**: WorldQuant uses a variety of techniques to ensure the robustness of [trading algorithms](../t/trading_algorithms.md), including extensive [out-of-sample testing](../o/out-of-sample_testing.md).
4. **Kaggle**: Kaggle competitions often emphasize the importance of out-of-sample performance in model evaluation, applicable to a [range](../r/range.md) of domains including [finance](../f/finance.md).
