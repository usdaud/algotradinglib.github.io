...
1. **Apple Inc. (AAPL):**
 - Apple’s invested [capital](../c/capital.md) includes its significant [equity](../e/equity.md) base from shareholders combined with various forms of [debt](../d/debt.md). Detailed financial information can be found on the Apple company filings.

2. **Tesla Inc. (TSLA):**
 - Tesla's invested [capital](../c/capital.md) consists of [equity](../e/equity.md) raised through IPOs and secondary offerings as well as significant [debt](../d/debt.md) from [bond](../b/bond.md) issuances.

3. **Microsoft [Corporation](../c/corporation.md) (MSFT):**
 - Microsoft's invested [capital](../c/capital.md) is predominantly [equity](../e/equity.md), supported by a mix of short-term and [long-term debt](../l/long-term_debt.md). [Investor](../i/investor.md) details can be explored at Microsoft company filings.
