...
## Overview
Intrinio is a financial data platform that provides high-quality, affordable, and easy-to-integrate financial data feeds for developers, investors, and businesses. Intrinio offers a wide [range](../r/range.md) of data services, including real-time and historical [market](../m/market.md) data, fundamental data, and [alternative data](../a/alternative_data.md), supported by [robust](../r/robust.md) APIs and SDKs for seamless integration into applications and platforms.

## Features
1. **[Real-Time Market Data](../r/real-time_market_data.md)**: Access to real-time stock prices, quotes, and [market](../m/market.md) data from global exchanges.
2. **Historical Data**: Comprehensive historical [market](../m/market.md) data for [backtesting](../b/backtesting.md), research, and analysis.
3. **Fundamental Data**: Detailed [financial statements](../f/financial_statements.md), ratios, and metrics for public companies.
...
10. **Cost-Effective Pricing**: Competitive pricing plans designed to make high-quality financial data accessible to a wide [range](../r/range.md) of users.

## Key Components
- **Stock Data API**: Real-time and historical stock prices, quotes, and [market](../m/market.md) data.
- **Fundamentals API**: Access to detailed [financial statements](../f/financial_statements.md), ratios, and metrics for public companies.
...
- **Data Feeds**: Continuous data feeds for real-time and historical [market](../m/market.md) data.
- **SDKs and Libraries**: SDKs for Python, Ruby, JavaScript, and other languages to simplify development.
- **Custom Data Solutions**: Personalized data solutions tailored to specific [business](../b/business.md) needs.
...
- **Trading Platforms**: Compatibility with trading platforms for seamless access to [market](../m/market.md) data and [execution](../e/execution.md) capabilities.
...
Intrinio offers extensive support through detailed documentation, user guides, tutorials, and a dedicated support team. Users can also access a [range](../r/range.md) of educational resources, webinars, and community forums to share insights, ask questions, and receive assistance from other developers and Intrinio experts.
