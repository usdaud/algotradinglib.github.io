...
Residual risk is the risk that remains after all mitigative actions have been applied to primary and secondary risks. It represents the potential for financial loss or other negative outcomes despite the implementation of [risk management](../r/risk_management.md) strategies. In the context of [algorithmic trading](../a/algorithmic_trading.md), residual risk can arise from model inaccuracies, unexpected market conditions, technological failures, or other unforeseen factors.
...
### 2. **Market Risk**
   ...
   **Causes**: Market risk in [algorithmic trading](../a/algorithmic_trading.md) can be influenced by sudden market shifts, low liquidity, or high volatility.
...
### 4. **Credit Risk**
   ...
   **Causes**: In [algorithmic trading](../a/algorithmic_trading.md), credit risk may arise from exposure to brokers, exchanges, or other financial entities.
...
### 2. **Market Risk Mitigation**
   ...
   - **[Position Sizing](../p/position_sizing.md)**: Implementing risk-based [position sizing](../p/position_sizing.md) to limit the impact of adverse market movements on the overall portfolio.
...
### 5. **Liquidity Risk Mitigation**
   - **[Market Depth Analysis](../m/market_depth_analysis.md)**: Analyzing the depth of markets to understand liquidity conditions and adjust [trading strategies](../t/trading_strategies.md) accordingly.
   ...
   - **Liquidity Providers**: Engaging with liquidity providers or utilizing [dark pools](../d/dark_pools.md) to access additional liquidity.
