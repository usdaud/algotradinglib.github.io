...
8. **[Quantitative Trading](../q/quantitative_trading.md) Firms**
 ...
 - **Two Sigma**../m/machine_learning.md) techniques and distributed computing to build sophisticated [trading algorithms](../t/trading_algorithms.md).
 ...
 - **Citadel**../m/machine_learning.md), and data analysis to forecast returns and execute trades.
