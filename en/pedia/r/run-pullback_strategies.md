...
- **Two Sigma** ( uses advanced [machine learning](../m/machine_learning.md) and statistical models for [trading strategies](../t/trading_strategies.md) including run-[pullback](../p/pullback.md) strategies.
- **AQR [Capital](../c/capital.md) Management** ( employs quant-driven investment strategies, leveraging [trend](../t/trend.md)-following and [pullback](../p/pullback.md) models.
