...
1. **Determine Net Income**: Net income is the total profit of a company after all expenses, taxes, and costs have been deducted. This information is usually available in a company's income statement.
2. **Determine Total Assets**: Total assets include all assets owned by a company, both current and non-current. This information can be found in the company's balance sheet.
3. **Apply the Formula**: Once you have the net income and total assets, you can calculate ROA using the formula mentioned earlier.
