...
The centerpiece of Rule 10b5-1 is the trading plan, which can be formalized in three specific scenarios:
  - **Specific Date:** The plan specifies the date or dates on which the trades will take place.
  - **Specific Price:** The plan specifies the price at which the trades will be executed.
  - **Specific Amount/Volume:** The plan specifies the amount or volume of stock to be traded.

### 2. **Good Faith and Formulation**
A trading plan must be established:
  - **In Good Faith:** Created without any intention to evade insider trading prohibitions.
