...
3. **Winton Group**
   - Winton Group, founded by David Harding, applies statistical and [mathematical models](../m/mathematical_models_in_trading.md) to [financial markets](../f/financial_market.md), including [relative value](../r/relative_value.md) strategies in commodities and other assets. Find more at [Winton Group](https://www.winton.com/).
