...
- **Basic Inc. v. Levinson** (1988): This case extended the rule’s reach by holding that information is considered material if there is a substantial likelihood that its disclosure would have been viewed by the reasonable investor as having significantly altered the total mix of information made available.
- **United States v. O'Hagan** (1997): The Court upheld the misappropriation theory of insider trading under Rule 10b-5, stating that a person violates the rule when trading on confidential information stolen from a fiduciary.
