...
Currency options give the holder the right, but not the obligation, to buy or sell a currency at a specified rate before or at expiration. They are widely used for hedging and speculative trading.

## Key Terms
- Call option: right to buy the base currency
- Put option: right to sell the base currency
- Premium: cost paid to the option seller

## Settlement
Currency options can be physically settled or cash settled. Premiums and payouts are typically denominated in one of the currencies in the pair.

## Use Cases
- Hedging foreign exchange exposure
- Speculating on directional moves or volatility
- Structuring risk-defined strategies

## Risks
Option pricing depends on implied volatility, interest rate differentials, and time to expiration. Liquidity can vary by currency pair and tenor.
