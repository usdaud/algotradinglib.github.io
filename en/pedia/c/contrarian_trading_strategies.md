...
Contrarian [trading strategies](../t/trading_strategies.md) are a popular approach in [financial markets](../f/financial_market.md) that revolve around going against the prevailing [market](../m/market.md) trends. The core principle is to buy when others are selling and to sell when others are buying. Contrarian traders believe that the crowd is often wrong, and by taking the opposite position, they can [capitalize](../c/capitalize.md) on the [market](../m/market.md)'s tendency to overreact to news and events. This guide [will](../w/will.md) explore the details of contrarian [trading strategies](../t/trading_strategies.md), including their [underlying](../u/underlying.md) principles, popular methodologies, psychological aspects, key indicators, and notable examples.

### Principles of Contrarian Trading

Contrarian trading is founded on the belief that [asset](../a/asset.md) prices reflect human emotions, such as fear and greed, which can create opportunities for [profit](../p/profit.md) when the [market](../m/market.md)'s sentiment reaches an extreme. Here are some principles that contrarian traders typically follow:

1. **[Market Sentiment](../m/market_sentiment.md)**: Contrarian traders focus on understanding the prevailing sentiment in the [market](../m/market.md). When the sentiment is excessively bullish (optimistic), they look for signs to sell. Conversely, when the sentiment is overly bearish (pessimistic), they look for buying opportunities.
2. **[Overreaction](../o/overreaction.md) to News**: Markets often overreact to news, leading to sharp price movements. Contrarian traders seek to exploit these overreactions by taking positions that anticipate a [reversal](../r/reversal.md).
3. **[Mean Reversion](../m/mean_reversion.md)**: This principle states that [asset](../a/asset.md) prices tend to revert to their historical averages over time. Contrarian traders use this concept to identify [overbought](../o/overbought.md) or [oversold](../o/oversold.md) conditions.
4. **[Liquidity](../l/liquidity.md)**: During periods of extreme sentiment, the [market](../m/market.md) may face [liquidity](../l/liquidity.md) constraints. Contrarian traders provide [liquidity](../l/liquidity.md) by taking the opposite side of crowded trades.
...
Contrarian trading requires a specific psychological mindset, as it involves taking positions that are often against the prevailing [market sentiment](../m/market_sentiment.md). Here are some psychological aspects to consider:

1. **Emotional Control**: Contrarian traders must be able to maintain emotional control and not be swayed by the [market](../m/market.md)'s exuberance or panic.
2. **Patience**: This strategy often requires a long-term perspective, as it can take time for the [market](../m/market.md) to correct its excesses and for contrarian positions to become profitable.
3. **Conviction**: A high level of conviction is essential, as contrarian trades can be challenging to [hold](../h/hold.md) onto when the [market](../m/market.md) continues to move against the position.
4. **Adaptability**: While a contrarian stance is essential, traders must also be willing to adapt their strategies when [market](../m/market.md) conditions change.
...
#### Advantages:
1. **Potential for High Returns**: Contrarian strategies can [yield](../y/yield.md) significant returns if the [market](../m/market.md) corrects its excessive sentiment.
2. **[Diversification](../d/diversification.md)**: By taking positions that are different from the crowd, contrarian traders can achieve greater [portfolio diversification](../p/portfolio_diversification.md).
3. **Lower Competition**: Since contrarian [investing](../i/investing.md) often goes against the grain, there is less competition in identifying and acting upon these trades.

#### Disadvantages:
1. **Timing Risks**: Incorrect timing can lead to losses, as it may take a while for the [market](../m/market.md) to align with the contrarian view.
2. **Emotional Strain**: Holding contrarian positions can be psychologically difficult, especially during periods of extreme [market](../m/market.md) movements.
3. **Potential for Extended Losses**: In cases where the [market sentiment](../m/market_sentiment.md) remains irrational for prolonged periods, contrarian positions can suffer extended losses.
