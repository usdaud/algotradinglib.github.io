...
CoinMetro places a strong emphasis on [security](../s/security.md) to protect users' assets and data. The platform employs [multiple](../m/multiple.md) [security](../s/security.md) measures, including:
