...
The cash market, also called the spot market, is where financial instruments are traded for immediate delivery and settlement. Prices in the cash market represent the current value of the asset.

## Characteristics
- Immediate execution at current prices
- Settlement occurs within a short period, depending on the asset class
- Used as the reference price for many derivatives

## Relation to Derivatives
Futures and options prices are often derived from the cash market using cost of carry models. The relationship between spot and futures is central to arbitrage and hedging.

## Trading Considerations
Cash markets tend to be more liquid for major assets, but liquidity can vary by asset class and trading hours. Spreads and market impact should be considered for large orders.
