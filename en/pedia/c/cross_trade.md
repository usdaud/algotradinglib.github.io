...
A cross trade occurs when a broker matches a buy order and a sell order internally at a single price. The trade is executed without exposing the orders to the broader market.

## Why It Is Used
- Reduce transaction costs
- Improve execution efficiency
- Match internal client flow

## Regulation
Cross trades are subject to strict rules to prevent conflicts of interest. Many venues require that cross trades occur at a fair price relative to the market.

## Risks
If not handled properly, cross trades can disadvantage one side. Transparency and compliance controls are essential.
