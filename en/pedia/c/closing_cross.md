...
The closing cross is an exchange mechanism that matches orders at the end of the trading day to establish the closing price. It is similar to a closing auction but is often referred to as a cross in some markets.
...
## Benefits
The closing cross concentrates liquidity, reduces spread impact, and provides a transparent closing price for the market.

## Risks
Late imbalances or order cancellations can shift the final price. Traders should be aware of timing rules and cutoffs for order submission.
