...
- **[Interactive Brokers](../i/interactive_brokers.md)**: Provides API access to build custom [trading algorithms](../t/trading_algorithms.md) that can consider receipt and holding period of securities [Interactive Brokers](https://www.interactivebrokers.com/).
