...
```
[Payout](../p/payout.md) = (Actual Coverage / Required Coverage) * Loss
[Payout](../p/payout.md) = ($600,000 / $800,000) * $200,000
[Payout](../p/payout.md) = 0.75 * $200,000
[Payout](../p/payout.md) = $150,000
```
...
The Waiver of Coinsurance Clause negates the necessity of coinsurance once the insured meets a certain threshold. This clause is typically applied in scenarios where the [value](../v/value.md) of the property or the amount of [insurance](../i/insurance.md) required fluctuates significantly, making it difficult to maintain consistent compliance with coinsurance requirements.
...
The waiver of coinsurance clause also has applications in [business](../b/business.md) interruption [insurance](../i/insurance.md). [Business](../b/business.md) interruption policies are designed to cover the loss of [income](../i/income.md) that a [business](../b/business.md) suffers after a disaster. Coinsurance requirements in [business](../b/business.md) interruption [insurance](../i/insurance.md) can compel insureds to calculate projected [income](../i/income.md) accurately. The waiver clause helps in mitigating the complexity involved in such calculations and prevents potential underpayment of claims.
