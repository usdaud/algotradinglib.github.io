...
## Overview
Wyden is a comprehensive [algorithmic trading](../a/algorithmic_trading.md) software platform designed to support the full lifecycle of [quantitative trading](../q/quantitative_trading.md) strategies. It provides the necessary tools and infrastructure for the development, [backtesting](../b/backtesting.md), and deployment of [algorithmic trading](../a/algorithmic_trading.md) strategies.

## Features
1. **Multi-Asset Class Support**: Wyden supports trading across various asset classes including equities, forex, futures, options, and cryptocurrencies.
