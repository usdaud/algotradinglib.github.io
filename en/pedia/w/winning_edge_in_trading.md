 ...
 **Example Companies:**
 - Two Sigma: A New York-based [hedge fund](../h/hedge_fund.md) that utilizes advanced technology and [data science](../d/data_science_in_trading.md) for [quantitative trading](../q/quantitative_trading.md).
 - Renaissance Technologies: Known for its Medallion [Fund](../f/fund.md), which leverages sophisticated [mathematical models](../m/mathematical_models_in_trading.md).
 ...
 **Example Companies:**
 - Virtu Financial: A leader in HFT and [market](../m/market.md) making, Virtu leverages state-of-the-art technology.
 - XTX Markets: An electronic [market maker](../m/market_maker.md) using [quantitative models](../q/quantitative_models.md) and technology to [trade](../t/trade.md) in [liquid](../l/liquid.md) markets.
 ...
 **Example Companies:**
 - Quandl: Provides [alternative data](../a/alternative_data.md) for financial and economic analysis.
 - Sentieo: A research platform [offering](../o/offering.md) [sentiment analysis](../s/sentiment_analysis.md) and [data visualization](../d/data_visualization.md).
 ...
 **Example Companies and Resources:**
 - Trading Psychology Edge: Provides resources and training on the mental aspects of trading.
 ...
 **Example Companies:**
 - Jane Street: Specializes in trading and technology to [capitalize](../c/capitalize.md) on [market](../m/market.md) inefficiencies.
