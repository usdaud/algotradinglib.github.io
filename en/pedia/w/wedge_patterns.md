...
- **[QuantConnect](../q/quantconnect.md)**: QuantConnect offers a cloud-based [algorithmic trading](../a/algorithmic_trading.md) platform, allowing users to design, backtest, and deploy [trading strategies](../t/trading_strategies.md), including those based on [wedge](../w/wedge.md) patterns.
- **[AlgoTrader](../a/algotrader.md)**: AlgoTrader provides comprehensive algo-trading software that supports various [trading strategies](../t/trading_strategies.md), including [technical analysis](../t/technical_analysis.md) and [pattern recognition](../p/pattern_recognition.md).
- **Trading Technologies**: Trading Technologies offers advanced trading tools and [algorithmic trading](../a/algorithmic_trading.md) solutions, enabling traders to implement and execute complex strategies based on technical patterns.
