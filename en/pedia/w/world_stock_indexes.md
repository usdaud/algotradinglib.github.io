...
**Overview:**
The Dow Jones Industrial Average (DJIA), also known simply as "The Dow," is a stock [market index](../m/market_index.md) that indicates the [value](../v/value.md) of 30 significant [stocks](../s/stock.md) traded on the New York Stock [Exchange](../e/exchange.md) (NYSE) and the [NASDAQ](../n/nasdaq.md).
...
**Overview:**
The [NASDAQ Composite Index](../n/nasdaq_composite_index.md) includes over 3,000 [stocks](../s/stock.md) [listed](../l/listed.md) on the [NASDAQ](../n/nasdaq.md) [Stock Market](../s/stock_market.md) and is heavily [weighted](../w/weighted.md) toward the [technology sector](../t/technology_sector.md).

**Historical Context:**
Established in 1971, the [NASDAQ](../n/nasdaq.md) Composite was the first electronic stock [market index](../m/market_index.md), setting a precedent for future stock exchanges.
...
Stock indexes provide a [benchmark](../b/benchmark.md) for measuring the performance of individual portfolios. Investors compare their portfolio returns with the returns of relevant indexes to gauge their investment success.
...
Indexes also function as leading [economic indicators](../e/economic_indicators.md). For example, a steady rise in stock indexes often precedes [economic growth](../e/economic_growth.md), whereas a consistent decline might signal an upcoming [recession](../r/recession.md).
...
A [price-weighted index](../p/price-weighted_index.md), like the Dow Jones Industrial Average, assigns greater influence to [stocks](../s/stock.md) with higher prices regardless of their [market capitalization](../m/market_capitalization.md).
...
Some indexes use an equal-[weighted](../w/weighted.md) approach, giving the same importance to each stock regardless of its price or [market](../m/market.md) cap.
