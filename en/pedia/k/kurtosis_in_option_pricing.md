...
When pricing options, traditional models such as the [Black-Scholes model](../b/black-scholes_model.md) assume that asset returns follow a normal distribution. This assumption leads to underestimating the probability of extreme price movements. In reality, financial returns often exhibit leptokurtic characteristics, meaning that the tails of the distribution are fatter, and extreme outcomes are more probable than a normal distribution would suggest.
