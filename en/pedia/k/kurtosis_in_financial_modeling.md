...
1. **[Hedge](../h/hedge.md) Funds and High-Frequency Trading**:
 - Firms such as Renaissance Technologies ( and D. E. Shaw Group ( [leverage](../l/leverage.md) sophisticated statistical models that often include [kurtosis](../k/kurtosis.md) to develop advanced [trading algorithms](../t/trading_algorithms.md).
...
2. **[Bank](../b/bank.md) [Risk Management](../r/risk_management.md)**:
 - Major [investment banks](../i/investment_bank_(ib).md) such as Goldman Sachs ( and JPMorgan Chase ( use [kurtosis](../k/kurtosis.md) in their [risk management](../r/risk_management.md) models to anticipate and prepare for financial [market](../m/market.md) shocks.
