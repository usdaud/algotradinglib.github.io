...
1. Historical Market Data: Price, volume, and trading activity across various assets such as stocks, bonds, commodities, and cryptocurrencies.
2. Real-Time Market Data: Streaming data of live trading sessions.
3. Economic Indicators: Data related to GDP, unemployment rates, consumer price index, interest rates, etc.
4. News and Social Media: Articles, blogs, tweets, and posts that can influence market sentiment.
5. Financial Reports: Quarterly and annual earnings reports, balance sheets, income statements.
6. Alternative Data: Satellite images, shipping data, web traffic statistics, etc.
...
- **Quandl**: Provides a wide range of financial, economic, and alternative data. [Quandl](https://www.quandl.com/)
- **Sentifi**: Specializes in alternative data and sentiment analysis. [Sentifi](https://www.sentifi.com/)
