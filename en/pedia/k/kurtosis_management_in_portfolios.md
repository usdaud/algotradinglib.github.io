...
Careful selection of assets with lower individual kurtosis can help manage the overall kurtosis of the portfolio. Analysts can screen for assets with historical returns that exhibit desired characteristics in terms of kurtosis.
...
Leverage can be employed judiciously to manage kurtosis, although it must be done with caution. Leveraging low-volatility, low-kurtosis assets may achieve desired return levels without increasing portfolio kurtosis unduly.
