...
## Calculation
1. Compute the standard deviation of returns over a chosen period.
2. Multiply by the square root of the number of periods in a year.

For example, if daily volatility is sigma_d, annualized volatility is:
