...
- **Boost**: This is a collection of libraries that extend the functionality of C++. Functions relevant to algorithmic trading include data structures, algorithms, and numerical computing.
- **QuantLib**: This open-source library provides tools for modeling, trading strategies, and pricing financial instruments.
- **Eigen**: A C++ template library for linear algebra, Eigen is highly useful for quantitative finance applications involving mathematical calculations.
...
- **Statistical Arbitrage**: This involves exploiting the mean-reverting behavior of asset prices using statistical and mathematical models.
- **Market Making**: This strategy uses algorithms to provide liquidity to the market by continuously buying and selling assets, thus capturing the bid-ask spread.
- **Momentum Trading**: This strategy aims to capitalize on market trends by going long on rising assets and short on falling ones.
- **Mean Reversion**: This strategy is based on the assumption that asset prices will revert to their historical average over time.
