...
## Overview
Alpaca is a commission-free, API-first stock brokerage platform that allows developers to build and deploy [trading algorithms](../t/trading_algorithms.md), applications, and [brokerage services](../b/brokerage_services.md). Known for its robust and user-friendly API, Alpaca caters to developers, algo traders, and financial institutions by providing seamless access to [real-time market data](../r/real-time_market_data.md) and trading functionalities.

## Features
1. **Commission-Free Trading**: Allows commission-free trading of U.S. stocks and ETFs.
...
- **Paper Trading**: [Simulated trading](../s/simulated_trading.md) environment to test strategies without financial risk.
...
- **[TradingView](../t/tradingview.md)**: Integration with [TradingView](../t/tradingview.md) for advanced charting and trade execution.
...
- **Fintech Companies**: Enables fintech companies to integrate [brokerage services](../b/brokerage_services.md) into their own platforms through Alpaca’s BaaS offering.
