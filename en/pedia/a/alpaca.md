...
4. **Paper Trading**: Offers a paper trading environment to test and refine trading strategies without risking real money.
5. **Advanced Order Types**: Supports various order types including market, limit, stop, and trailing stop orders.
6. **Algo Trading**: Enables algorithmic trading with support for automated trading strategies.
