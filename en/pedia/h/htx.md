...
HTX, formerly known as Huobi Global, is one of the longest-running cryptocurrency exchanges and trading platforms. Originally launched in 2013 in China by Leon Li, its operations cover a broad spectrum of crypto services, including spot and [margin trading](../m/margin_trading.md), [derivatives](../d/derivatives.md), and staking services. HTX provides a global marketplace for the trading of various cryptocurrencies and is renowned for its [liquidity](../l/liquidity.md) and advanced trading features.

## History and Evolution

HTX began its journey in 2013 under the name Huobi. Initially, it served as a [Bitcoin](../b/bitcoin.md) [exchange](../e/exchange.md) in China but soon expanded to include various altcoins and new financial products. Following China's cryptocurrency ban in 2017, Huobi relocated its operations internationally. In September 2023, it rebranded to HTX (combining "Huobi" and "Tron" after Justin Sun's acquisition), marking a new chapter in its history with an updated vision and mission to cater to the evolving needs of global crypto traders.
...
- **Fill or [Kill](../k/kill.md) (FOK):** An [order](../o/order.md) that must be filled entirely immediately or canceled.
...
The OTC [trading desk](../t/trading_desk.md) enables large-[volume](../v/volume.md) trades to be executed discreetly. This service is ideal for institutions looking to enter or exit positions without causing significant [market](../m/market.md) movements. Benefits include:
...
- **Rebranding:** The transition from Huobi Global to HTX reflects a broader vision and a commitment to evolving with the [industry](../i/industry.md) under new leadership.
...
- **[Expansion](../e/expansion.md) into New Markets:** HTX has been expanding its services into new geographic regions, aiming to cater to a growing global user base.
