...
- Increasing size after a series of wins without evidence of edge.
- Ignoring risk limits because recent trades worked out.
- Assuming the market will keep rewarding the same pattern.
...
## Practical checklist
- Define the time horizon for Hot Hand Fallacy and the market context.
...
## Common pitfalls
- Treating Hot Hand Fallacy as a standalone signal instead of context.
