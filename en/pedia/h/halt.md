...
## Common reasons
- Pending news that could materially affect price.
- Volatility controls triggered by rapid price moves.
- Regulatory or compliance concerns.
- Technical problems at the exchange.

## Types of halts
- News pending or news released halts.
- Volatility pauses under limit up limit down rules.
...
## Practical checklist
- Define the time horizon for Halt and the market context.
...
## Common pitfalls
- Treating Halt as a standalone signal instead of context.
