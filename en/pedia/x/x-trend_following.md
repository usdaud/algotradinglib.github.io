...
Renaissance Technologies is one of the most well-known firms employing sophisticated [quantitative models](../q/quantitative_models.md), including advanced [trend](../t/trend.md)-following algorithms.

**2. Two Sigma**
Two Sigma uses [machine learning](../m/machine_learning.md), distributed computing, and other advanced technologies to manage assets via algorithmic strategies, including [trend following](../t/trend_following.md). Detailed information is available in their materials.
