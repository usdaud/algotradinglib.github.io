...
- **Correlation**: Understanding the strength and direction of the relationship between the two variables.
- **Outliers**: Identifying data points that deviate significantly from the overall pattern.
- **Trend lines**: Sometimes added to display the direction and strength of the relationship.
