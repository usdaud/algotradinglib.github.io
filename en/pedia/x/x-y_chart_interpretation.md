...
[Algorithmic trading](../a/algorithmic_trading.md) involves using computer algorithms to execute trading orders at high speeds, often based on pre-determined criteria. [X-Y charts](../x/x-y_charts.md) are extensively used in this domain for various analyses:
...
Interpreting [X-Y charts](../x/x-y_charts.md) requires understanding statistical and visual patterns. Here are some techniques:
