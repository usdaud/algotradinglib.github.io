...
[Quantitative analysis](../q/quantitative_analysis.md) involves the use of mathematical and statistical models to evaluate market data and make trading decisions. Models may include:
...
#### Backtesting
[Backtesting](../b/backtesting.md) is the process of testing a trading strategy on historical data to determine its viability. It helps in understanding how a strategy would have performed in different market conditions.
...
1. **[Black-Scholes Model](../b/black-scholes_model.md):** Used for options pricing. The model estimates the price of European-style options.
2. **[GARCH Models](../g/garch_models.md) (Generalized Autoregressive Conditional Heteroskedasticity):** Used to model and forecast [financial time series](../f/financial_time_series.md) data, especially the volatility of returns.
...
2. **Numerai** - [Numerai](https://numer.ai/)
   ...
   Numerai is a hedge fund that leverages crowd-sourced machine learning to run market-neutral [trading models](../t/trading_models.md).
...
4. **Jane Street** - [Jane Street](https://www.janestreet.com/)
   ...
   Jane Street employs various [quantitative models](../q/quantitative_models.md) and cutting-edge technology to engage in trading and market-making.
