...
- **Python**: Widely used for algorithmic trading due to its extensive libraries like Pandas, NumPy, and Scikit-learn.
...
- **QuantConnect**: An open-source algorithmic trading platform that supports Python and C#. (https://www.quantconnect.com/)
- **Backtrader**: A Python library for backtesting trading strategies. (https://www.backtrader.com/)
- **PyAlgoTrade**: A library that allows backtesting of TA-Lib based strategies. (https://github.com/gbeced/pyalgotrade)
...
- **Jane Street**: Known for its quantitative trading strategies, which includes pattern-based trading techniques. (https://www.janestreet.com/)

### Financial Institutions

- **Goldman Sachs**: Utilizes sophisticated algorithms and advanced trading strategies, including pattern recognition techniques, for market-making and proprietary trading. (https://www.goldmansachs.com/)
