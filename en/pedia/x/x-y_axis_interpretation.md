...
- **Y-Axis (Vertical Axis):** Represents the variable of interest, such as price, returns, volume, or specific [performance metrics](../p/performance_metrics.md).
...
2. **[Performance Metrics](../p/performance_metrics.md):**
   ...
   - **[Drawdown Analysis](../d/drawdown_analysis.md):** Visualizes periods of decline from a historical peak in a portfolio. X-axis as time, y-axis as drawdown percentage.
...
2. **[Anomaly Detection](../a/anomaly_detection.md):**
   ...
   - Use [Bollinger Bands](../b/bollinger_bands.md) in time series plots to identify unusual volatility or price movements.
