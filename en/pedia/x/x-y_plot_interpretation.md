...
2. **[Pairs Trading](../p/pairs_trading.md)**:
   - [Pairs trading](../p/pairs_trading.md) strategies rely on the statistical correlation between two assets. An X-Y plot of asset prices helps detect [arbitrage](../a/arbitrage.md) opportunities when the historically correlated assets diverge.

3. **Market [Signal Analysis](../s/signal_analysis.md)**:
   - By plotting [technical indicators](../t/technical_indicators.md) (e.g., moving averages, RSI) against asset prices, traders can validate the strength of [trading signals](../t/trading_signals.md) and fine-tune their strategies.
