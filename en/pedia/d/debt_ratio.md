...
- **Two Sigma**: An [investment management](../i/investment_management.md) [firm](../f/firm.md) that uses [machine learning](../m/machine_learning.md), distributed computing, and sophisticated algorithms to maximize returns. [Debt](../d/debt.md) ratios might be one of many financial metrics factored into their algorithms.

- **Renaissance Technologies**: Known for its Medallion [Fund](../f/fund.md), which applies [quantitative models](../q/quantitative_models.md) derived from mathematical and statistical analyses. [Debt](../d/debt.md) ratios and other financial metrics would likely be inputs in their models.
