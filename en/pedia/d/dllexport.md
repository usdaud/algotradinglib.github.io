...
**DllExport** is a system utility designed to export functions from.NET assemblies as native DLL exports. By providing a bridge between managed (.NET) code and native applications, DllExport enables seamless integration of modern trading platforms (such as [QuantConnect](../q/quantconnect.md), Tiger.Trade or [Lean](../q/quantconnect.md)) with legacy systems like [MetaTrader 4 (MT4)](../m/metatrader4.md) and [MetaTrader 5 (MT5)](../m/metatrader5.md).
...
- **Integration with Legacy Trading Platforms:**
 Financial institutions and independent developers can integrate modern, feature-rich trading applications like [QuantConnect](../q/quantconnect.md) or Lean with well-established legacy platforms such as [MT4](../m/metatrader4.md) and [MT5](../m/metatrader5.md). This integration allows traders to [leverage](../l/leverage.md) modern analytical tools while maintaining compatibility with widely used legacy systems.
