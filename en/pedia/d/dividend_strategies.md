...
- **[QuantConnect](../q/quantconnect.md)**: QuantConnect offers a powerful [algorithmic trading](../a/algorithmic_trading.md) platform that supports the creation, [backtesting](../b/backtesting.md), and live deployment of [dividend](../d/dividend.md) strategies.
...
- **[Alpaca](../a/alpaca.md)**: Alpaca offers [commission](../c/commission.md)-free trading APIs that can be used to implement and execute algorithmic [dividend](../d/dividend.md) strategies.
