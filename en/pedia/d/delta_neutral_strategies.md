...
Citadel Securities is an example of a leading [algorithmic trading](../a/algorithmic_trading.md) [firm](../f/firm.md) that utilizes [delta](../d/delta.md)-[neutral](../n/neutral.md) strategies in its [market](../m/market.md) making and trading operations.
