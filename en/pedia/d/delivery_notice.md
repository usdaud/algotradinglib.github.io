...
A delivery notice is a formal notification in futures markets that a short position intends to make delivery of the underlying asset. It initiates the delivery process in physically settled contracts.

## Process
- The short submits a notice to the clearinghouse
- The clearinghouse assigns a long position to receive delivery
- Terms are based on exchange rules and contract specifications

## Timing
Delivery notices typically start after first notice day and can continue until the contract expires. The timing affects liquidity and pricing behavior.

## Trading Impact
After delivery notices begin, liquidity in the contract can decline. Many traders exit or roll positions before this period to avoid delivery risk.

## Operational Risks
Failure to manage delivery notices can lead to operational complications and unexpected obligations. Traders should track first notice day and last trading day closely.

## Practical Notes
Some contracts allow for cash settlement instead of physical delivery. Always verify settlement terms to avoid surprises.
