...
- QuantConnect: An [algorithmic trading](../a/algorithmic_trading.md) platform that offers extensive tools for developing and testing algorithms, including [risk management](../r/risk_management.md) analytics.
- Kensho by S&P Global: Provides advanced analytics and insights, including [risk measures](../r/risk_measures.md) such as downside deviation.
- Morningstar: Offers various [investment analysis](../i/investment_analysis.md) tools, including metrics on [downside risk](../d/downside_risk.md) and performance evaluation.
