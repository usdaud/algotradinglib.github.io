...
Under the DES term, the seller is responsible for delivering the goods to the buyer on board a ship at the destination port. The seller assumes all costs and risks associated with transporting the goods to that point, excluding the unloading costs and customs duties. Once the goods are delivered on board the ship at the destination port, the [risk](../r/risk.md) is transferred from the seller to the buyer.
...
- **Clear [Risk](../r/risk.md) Demarcation**: The [transfer of risk](../t/transfer_of_risk.md) is clearly defined, reducing potential disputes over responsibilities once the goods are delivered on board the ship at the destination port.
...
- **Complex [Logistics](../l/logistics.md)**: Managing international shipping [logistics](../l/logistics.md) up to the destination port can be complex and requires thorough planning and coordination.

### Advantages for the Buyer

- **Reduced [Risk](../r/risk.md) During Transit**: The buyer is not responsible for the goods during the transit to the destination port, which reduces their [risk](../r/risk.md) exposure and potential liabilities.
- **Simplified [Import](../i/import.md) Process**: With the seller responsible for transportation up to the destination port, the buyer's primary focus is on the [import](../i/import.md) process once the goods arrive.
...
- **[Import](../i/import.md) Formalities**: The buyer is responsible for all [import](../i/import.md) formalities, including customs clearance and [payment](../p/payment.md) of [import](../i/import.md) duties, which can be time-consuming and complex.

## Practical Use Cases

### Manufacturing Industry

In the [manufacturing](../m/manufacturing.md) [industry](../i/industry.md), companies often source [raw materials](../r/raw_materials.md) or components from international suppliers. Using DES terms can streamline the [procurement](../p/procurement.md) process, as the supplier assumes responsibility for delivering the goods to the designated port. This allows the purchasing company to focus on production without worrying about transportation [logistics](../l/logistics.md).

### Automotive Sector

Automotive manufacturers frequently [import](../i/import.md) parts and components from various countries. By using DES terms, the manufacturers can reduce their logistical burden and concentrate on the assembly process. The clear delineation of responsibilities also helps in managing [supply chain](../s/supply_chain.md) risks more effectively.

### Retail Industry

Large retail chains that [import](../i/import.md) products for resale may use DES terms to ensure smooth delivery of goods to their [distribution](../d/distribution.md) centers. This reduces the retailer's [risk](../r/risk.md) exposure during transit and simplifies the [logistics](../l/logistics.md) management, allowing them to focus on [inventory management](../i/inventory_management.md) and sales.

## Conclusion

Delivered Ex Ship (DES) is a valuable Incoterm for international [trade](../t/trade.md), providing a clear framework for the responsibilities and risks associated with shipping and delivery. By understanding the nuances of DES, both sellers and buyers can minimize disputes, streamline their [logistics](../l/logistics.md) processes, and focus on their core [business activities](../b/business_activities.md). Proper implementation of DES terms requires thorough planning, clear communication, and meticulous documentation to ensure a smooth and efficient [transaction](../t/transaction.md).