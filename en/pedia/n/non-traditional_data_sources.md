...
1. **[Social Media](../s/social_media.md) Data**
 ...
 Example: Firms like Dataminr specialize in real-time [social media analytics](../s/social_media_analytics.md) to detect [market](../m/market.md) trends and signals.
...
2. **Satellite Imagery**
 ...
 Example: Companies like Orbital Insight [offer](../o/offer.md) platforms that analyze satellite imagery for actionable insights.
...
3. **[Geolocation](../g/geolocation.md) Data**
 ...
 Example: SafeGraph, a data company, specializes in providing precise geospatial data on physical places.
...
4. **Web Scraping**
 ...
 Example: Diffbot uses AI to scrape and structure web data automatically.
...
5. **[Credit Card](../c/credit_card.md) [Transaction](../t/transaction.md) Data**
 ...
 Example: Firms such as Second Measure analyze billions of anonymized purchases to derive actionable insights.
...
6. **Sensor Data**
 ...
 Example: Uptake provides industrial AI and IoT analytics to derive actionable insights from sensor data.
...
7. **Environmental, Social, and Governance (ESG) Data**
 ...
 Example: Sustainalytics offers comprehensive ESG research and ratings.
