...
- **[QuantConnect](../q/quantconnect.md)**: quantconnect.com
 - [QuantConnect](../q/quantconnect.md) provides a [algorithmic trading](../a/algorithmic_trading.md) platform that supports a variety of [noise](../n/noise.md) filtering techniques, including moving averages, Kalman filters, [Bollinger Bands](../b/bollinger_bands.md), and Fourier Transform-based methods.
