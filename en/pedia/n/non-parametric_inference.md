...
### Numerai
[Numerai](https://numer.ai) is a [hedge fund](../h/hedge_fund.md) that leverages machine learning and non-parametric methods to build [trading models](../t/trading_models.md). They aggregate models from a global community of data scientists to optimize their trading decisions.
