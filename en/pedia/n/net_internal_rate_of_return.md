...
Where:
- \( CF_t \) represents the net cash flow at time t.
- \( NIRR \) is the Net Internal Rate of Return.
...
(Note: This is a placeholder link; replace with actual relevant links if needed)