...
The data for the NAWI is sourced from the wage reports submitted by employers to the Internal [Revenue](../r/revenue.md) Service (IRS). This data represents the taxable [earnings](../e/earnings.md) of workers, and it is compiled annually. The precise methodology involves the wage records from the Master [Earnings](../e/earnings.md) File (MEF), which contains extensive details on [earnings](../e/earnings.md) for individuals covered under [Social Security](../s/social_security.md).
...
Once the average wage for a specific year is determined, it is compared to previous years to provide a measure of wage [inflation](../i/inflation.md) or [deflation](../d/deflation.md).

## Historical Trends

Analyzing the trends in the NAWI can provide valuable insights into the [economic conditions](../e/economic_conditions.md) over different periods. For instance, during periods of economic [expansion](../e/expansion.md), one would expect to see a rise in the NAWI, reflecting increasing wages. Conversely, during economic recessions or downturns, the NAWI might stagnate or decline. A review of historical data reveals patterns that correlate with broader [economic cycles](../e/economic_cycles.md).

### Example:

In 2019, the NAWI was $54,099.99. In comparison, in 2012, it was $44,321.67. This increase over seven years indicates an overall rise in the average wages of workers, signifying [economic growth](../e/economic_growth.md) over this period.

## Adjustment of Social Security Benefits

The NAWI is crucial for adjusting [Social Security](../s/social_security.md) benefits to ensure that they keep pace with [inflation](../i/inflation.md) and changes in wage levels. The SSA uses the NAWI to update various aspects of [Social Security](../s/social_security.md) calculations, such as:

- **Cost-of-Living Adjustments (COLA):** This ensures beneficiaries receive payments that reflect current living costs.
- **Contribution and Benefit Base:** This is the maximum taxable [earnings](../e/earnings.md) that are subject to [Social Security](../s/social_security.md) tax.
- **Bend Points:** Used to calculate the Primary [Insurance](../i/insurance.md) Amount (PIA) for retirement benefits.

### Example:

If the NAWI for a given year rises by 3%, then the benefits tied to the NAWI might also be slated to increase by an analogous percentage, ensuring that the [purchasing power](../p/purchasing_power.md) of [social security](../s/social_security.md) beneficiaries is maintained.

## Implications for Policy and Planning

The NAWI is not just a tool for adjusting [social security](../s/social_security.md) benefits but also provides a reflective measure for policymakers and economists. It helps in:
