...
- **Key Tools**:
 - MetaTrader - [QuantConnect](../q/quantconnect.md) (
...
- **Platforms**:
 ...
 - RiskMetrics by MSCI - [Quantitative Risk Management](../q/quantitative_risk_management.md) (QRM) applications.
...
- **Analysis Tools**:
 ...
 - R's PerformanceAnalytics package - Excel-based [financial analysis](../f/financial_analysis.md) tools.
...
- **Tools**:
 ...
 - R's FactorAnalytics package - [Financial analysis](../f/financial_analysis.md) software such as EViews (
...
- **Platforms**:
 - ScenarioLab - Microsoft Excel with specialized add-ins for [scenario analysis](../s/scenario_analysis.md).
...
- **Tools**:
 - [Morningstar](../m/morningstar.md) Direct (
...
- **Tools**:
 ...
 - MATLAB’s [Sensitivity Analysis](../s/sensitivity_analysis.md) toolkit (
 - R’s sensitivity package
...
- **Tools**:
 ...
 - [Financial modeling](../f/financial_modeling.md) software such as Portfolio Visualizer (
