...
### Hedge Funds
 ...
 - Examples include AQR [Capital](../c/capital.md) Management AQR and Renaissance Technologies Rentech.

### Investment Banks
 - [Investment banks](../i/investment_bank_(ib).md) utilize these models for prop trading and managing proprietary portfolios.
 - Firms like Goldman Sachs Goldman Sachs and J.P. Morgan J.P. Morgan are notable examples.
...
### Asset Management Firms
 ...
 - Vanguard Vanguard and BlackRock BlackRock are key [industry](../i/industry.md) players.

### Algorithmic Trading Platforms
 - Platforms like [QuantConnect](../q/quantconnect.md) QuantConnect and Tradeworx Tradeworx [offer](../o/offer.md) tools and environments to implement and test [Yield](../y/yield.md)-[Risk Models](../r/risk_models_in_trading.md).
...
- AQR [Capital](../c/capital.md) Management AQR
