...
Retail platforms like [QuantConnect](../q/quantconnect.md) and [Alpaca](../a/alpaca.md) provide tools that enable individual traders and smaller firms to implement yield forecasting strategies in their [algorithmic trading](../a/algorithmic_trading.md) systems.
