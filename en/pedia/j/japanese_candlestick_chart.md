...
- A filled body often indicates a close below the open, while a hollow body indicates a close above the open.
...
## Practical checklist
- Define the time horizon for Japanese Candlestick Chart and the market context.
...
## Common pitfalls
- Treating Japanese Candlestick Chart as a standalone signal instead of context.
