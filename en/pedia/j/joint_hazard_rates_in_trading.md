...
In the realm of [credit](../c/credit.md) [derivatives](../d/derivatives.md), [joint](../j/joint.md) hazard rates are vital in pricing and valuing multi-name [credit default swaps](../c/credit_default_swaps.md) (CDS). These instruments depend on the likelihood of [multiple](../m/multiple.md) obligors defaulting simultaneously. More information can be found on the [International Swaps and Derivatives Association (ISDA)](https://www.isda.org/) website.
