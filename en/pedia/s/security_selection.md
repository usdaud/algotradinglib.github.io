...
[Sentiment analysis](../s/sentiment_analysis.md) examines news articles, social media, and other text-based data sources to gauge market sentiment and select securities accordingly. Natural language processing (NLP) techniques enable algorithms to process and interpret large volumes of text data, identifying positive or negative sentiment towards specific securities. Traders can use [sentiment analysis](../s/sentiment_analysis.md) to complement other methods, such as technical or [fundamental analysis](../f/fundamental_analysis.md), to refine their security selection.
