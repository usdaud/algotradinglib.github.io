...
- **Stop-loss Orders**: To manage risk, traders often use stop-loss orders that automatically close the position once it moves against them by a predefined amount.
