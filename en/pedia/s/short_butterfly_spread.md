...
- **Sell One Lower Strike Call**: Sell one call option with a lower strike price.
- **Buy Two Middle Strike Calls**: Buy two call options at a middle strike price.
- **Sell One Higher Strike Call**: Sell one call option with a higher strike price.

### Example Structure:

Assume the underlying asset is trading at $100:
...
The maximum profit is achieved when the underlying asset's price is at the middle strike price at expiration. At this point, the trader benefits from the premiums received from the sold options while the purchased options are worthless or minimally valuable but less than the total received premiums.

### Breakeven Points:

The breakeven points are derived from the net premium and the strike prices. There are two breakeven points:
- Lower Breakeven Point = Lower Strike Price + Net Premium
- Upper Breakeven Point = Higher Strike Price - Net Premium
...
This strategy thrives in low volatility markets. When asset prices aren't expected to move significantly, Short Butterfly Spreads can offer a profitable way to earn from time decay.
...
Despite offering defined profits, the potential gains from Short Butterfly Spreads are relatively modest. This might not appeal to traders looking for high-reward opportunities.
...
- **[Interactive Brokers](../i/interactive_brokers.md)**: Offers advanced tools and analytics for options trading. [Visit Website](https://www.interactivebrokers.com/en/index.php?f=4985)
- **[E*TRADE](../e/e_trade.md)**: Intuitive platform for options analysis and trading. [Visit Website](https://us.etrade.com/home)
