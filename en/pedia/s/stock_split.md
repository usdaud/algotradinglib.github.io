...
1. **Increase [Liquidity](../l/liquidity.md)**: By reducing the price per share, the stock becomes more attractive to small investors, due to its lower cost, potentially increasing [market](../m/market.md) [liquidity](../l/liquidity.md).
...
- Each [shareholder](../s/shareholder.md) with 1 share [will](../w/will.md) receive an additional share.
- The price per share [will](../w/will.md) be adjusted to $100.
- If an [investor](../i/investor.md) owned 100 [shares](../s/shares.md) before the split, they would own 200 [shares](../s/shares.md) after.

## Impact on Shareholders

The [value](../v/value.md) of an [investor](../i/investor.md)'s holding won't change at the time of the split. Continuing the XYZ example, an [investor](../i/investor.md) with 100 [shares](../s/shares.md) valued at $200 each would see their total investment remain at $20,000 even post-split (200 [shares](../s/shares.md) valued at $100 each).

## Key Considerations

1. **Non-Dilutive Action**: A stock split does not dilute ownership stakes. While the number of [shares](../s/shares.md) outstanding increases, the percentage ownership remains the same for each [shareholder](../s/shareholder.md).

2. **Potential [Market](../m/market.md) Reactions**: While a stock split can signal company growth and lead towards positive [market](../m/market.md) reactions, it is not inherently indicative of financial improvements.

3. **Tax Implications**: Stock splits do not create taxable events for shareholders. Their [cost basis](../c/cost_basis.md) is adjusted to reflect the split, impacting [capital](../c/capital.md) gains calculations when [shares](../s/shares.md) are sold.
...
- If an [investor](../i/investor.md) owned 500 [shares](../s/shares.md) at $2 per share, post-split, they would own 100 [shares](../s/shares.md) valued at $10 per share.
- The overall [value](../v/value.md) of the investment remains the same at $1,000.
