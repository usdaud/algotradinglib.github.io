...
### 1. **News Articles and Media**
 ...
 - **Example**: Sentdex ( offers [sentiment analysis](../s/sentiment_analysis.md) specifically geared towards [financial markets](../f/financial_market.md).
...
### 2. **Social Media**
 ...
 - **Example**: Dataminr ( uses AI to analyze [social media](../s/social_media.md) for [market](../m/market.md)-relevant sentiment signals.
...
### 1. **Natural Language Processing (NLP)**
 ...
 - **Example**: TextBlob provides simple API for NLP tasks.
...
### 2. **Machine Learning**
 ...
 - **Example**: Scikit-learn for building ML models.
...
### 1. **Data Collection**
 ...
 - **Example**: Using Tweepy to collect real-time tweets.
...
### 2. **Data Cleaning**
 ...
 - **Example**: Using Pandas to clean and preprocess data.
...
### 5. **Backtesting**
 ...
 - **Tools**: [Backtrader](../b/backtrader.md), [StockSharp](../s/stocksharp.md).
 - **Example**: [QuantConnect](../q/quantconnect.md) ( for [backtesting](../b/backtesting.md) and live trading.
...
### 6. **Live Trading**
 ...
 - **Example**: [Alpaca](../a/alpaca.md) API ( for live trading.
