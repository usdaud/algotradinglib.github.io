...
### StockSharp
[StockSharp](../s/stocksharp.md) is a [algorithmic trading](../a/algorithmic_trading.md) platform that offers data, [backtesting](../b/backtesting.md) capabilities, and live trading functionalities. It supports C#, and provides a vast array of data sources for historical testing.
