...
- **VADER (Valence Aware Dictionary and sEntiment Reasoner):** A lexicon and rule-based [sentiment analysis](../s/sentiment_analysis.md) tool specifically attuned to sentiments expressed in social media.
...
### Data Collection
The first step for incorporating social media sentiment into [trading algorithms](../t/trading_algorithms.md) is data collection. Traders typically gather data from major social media platforms using APIs:
...
- **Volatility Adjustment:** Adjusting positions based on the predicted market volatility derived from [sentiment analysis](../s/sentiment_analysis.md).
- **Event-driven Strategies:** Reacting to significant sentiment changes around events like earnings reports, product launches, or [geopolitical events](../g/geopolitical_events.md).
...
- **[StockTwits](https://stocktwits.com/):** A social media platform for traders and investors, providing [sentiment analysis](../s/sentiment_analysis.md) and streaming market data.
