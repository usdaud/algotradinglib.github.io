...
3. **Salary Continuation**: Some businesses keep the employee on the [payroll](../p/payroll.md) for a predetermined period of time after the termination, allowing them to receive their regular salary.

### Benefits Continuation

It is common for companies to continue [offering](../o/offering.md) benefits to terminated employees for a set period. These benefits may include:

- **[Health Insurance](../h/health_insurance.md)**: Ongoing healthcare coverage is often part of severance packages. Companies may continue to cover their portion of premiums under programs like COBRA (Consolidated Omnibus [Budget](../b/budget.md) [Reconciliation](../r/reconciliation.md) Act) in the United States.
- **Pension Benefits**: Employees might continue to [accrue](../a/accrue.md) benefits or retain access to their pension plans.
- **Stock [Options](../o/options.md)**: Some severance agreements may stipulate the [vesting](../v/vesting.md) of stock [options](../o/options.md) or other [equity](../e/equity.md) benefits.

### Outplacement Services

[Outplacement](../o/outplacement.md) services help departing employees find new jobs more quickly. These services can include career counseling, [resume](../r/resume.md) writing workshops, and job placement assistance. Providing these services not only helps the affected employee but also aids the company in maintaining its reputation.
...
Court rulings can also shape severance pay by interpreting the [obligations](../o/obligation.md) of employers under contractual or statutory conditions. Employers need to stay updated on relevant legal precedents in their jurisdiction to ensure compliance.

## Business Considerations

### Financial Planning

The cost of providing severance pay can be significant, especially for larger companies undergoing significant downsizing. Many firms set aside financial reserves to cover these contingencies. Accurate [financial planning](../f/financial_planning.md) for severance helps mitigate the economic impact on the organization.
...
In cases of massive layoffs or corporate [bankruptcy](../b/bankruptcy.md), severance packages can be particularly complex. Under [bankruptcy](../b/bankruptcy.md) laws, severance agreements can be voided or altered as the company's assets are distributed to creditors. [Welfare](../w/welfare.md) programs or governmental funds may sometimes provide partial compensation in such scenarios.
...
Employees can sometimes negotiate the terms of their severance packages, especially if they have unique skills or [leverage](../l/leverage.md). Points commonly negotiated include:

- **Amount of Monetary Compensation**: Employees may negotiate for a higher [payout](../p/payout.md) based on tenure, specialized skills, or prior achievements.
- **Extended Benefits**: Terms for continued [health insurance](../h/health_insurance.md), pension plans, or stock [options](../o/options.md) are often [negotiable](../n/negotiable.md).
- **Other Perks**: Inclusion of [outplacement](../o/outplacement.md) services, the use of company equipment (like laptops or mobile phones), and even non-disparagement clauses can be part of severance discussions.
