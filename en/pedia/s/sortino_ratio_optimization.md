...
### QuantConnect
QuantConnect is an open-source, cloud-based [algorithmic trading](../a/algorithmic_trading.md) platform that supports the development and optimization of [trading algorithms](../t/trading_algorithms.md). The community-driven platform allows users to backtest, optimize, and deploy [trading algorithms](../t/trading_algorithms.md) across various asset classes. Learn more at [QuantConnect](https://www.quantconnect.com/).

### QuantLib
QuantLib is an open-source library for [quantitative finance](../q/quantitative_finance.md), particularly suited for [algorithmic trading](../a/algorithmic_trading.md). It provides tools for modeling, trading, and [risk management](../r/risk_management.md). QuantLib can be utilized to calculate and optimize the [Sortino ratio](../s/sortino_ratio.md) as part of a broader trading strategy. More information is available at [QuantLib](http://quantlib.org/).
