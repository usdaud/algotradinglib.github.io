...
## How it works
- The trader requests a borrow for a specific stock.
- The broker locates shares from lenders such as funds or custodians.
- The borrowed shares are delivered to the buyer when the short sale is executed.
...
## Practical checklist
- Define the time horizon for Short Borrow and the market context.
...
## Common pitfalls
- Treating Short Borrow as a standalone signal instead of context.
