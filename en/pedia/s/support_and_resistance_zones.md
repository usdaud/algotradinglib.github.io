...
[Support and resistance](../s/support_and_resistance.md) are foundational concepts in [technical analysis](../t/technical_analysis.md) and [algorithmic trading](../a/algorithmic_trading.md), serving as critical indicators for [price action](../p/price_action.md) predictions and [trading strategies](../t/trading_strategies.md). Understanding these zones can significantly enhance the effectiveness of an [algorithmic trading](../a/algorithmic_trading.md) system by helping identify key levels where the price of an [asset](../a/asset.md) is likely to experience a [reversal](../r/reversal.md) or continuation of a [trend](../t/trend.md).

## Definition and Explanation

### Support
Support refers to a [price level](../p/price_level.md) where a declining [asset](../a/asset.md) tends to find buying [interest](../i/interest.md) strong enough to [hold](../h/hold.md) the price above that level. This is a [price level](../p/price_level.md) at which the [demand](../d/demand.md) for an [asset](../a/asset.md) is thought to be strong enough to prevent the price from declining further. As the price drops towards the support level, it signals a potential buying opportunity, as historically the price has tended to reverse upwards from this area.

### Resistance
Resistance, on the other hand, is a [price level](../p/price_level.md) where a rising [asset](../a/asset.md) encounters selling pressure significant enough to prevent the price from increasing further. This area serves as a ceiling, preventing the price from moving higher. When the price approaches resistance, it often signifies a selling opportunity, as this level has historically shown to reverse the price to the downside.

## Identifying Support and Resistance Zones

### Historical Price Data
The most common method to identify [support and resistance](../s/support_and_resistance.md) levels is by analyzing historical price data. Traders look for [multiple](../m/multiple.md) instances where the price has reversed at the same level. For instance, if the price has bounced upwards [multiple](../m/multiple.md) times from a certain level, it is identified as a support level. Conversely, if the price has been rejected downwards [multiple](../m/multiple.md) times from a certain level, it is considered a resistance level.
...
### Moving Averages
Moving averages are also used to identify dynamic [support and resistance](../s/support_and_resistance.md) levels. For instance, the [200-day moving average](../1/200-day_moving_average.md) is often considered a significant [indicator](../i/indicator.md) of long-term trends. If the current price is above the moving average, it may act as a support. Conversely, if the price is below the moving average, the moving average may act as a resistance.

### Fibonacci Retracement Levels
[Fibonacci retracement](../f/fibonacci_retracement.md) levels are calculated by taking two extreme points on a price chart and dividing the vertical distance by key Fibonacci ratios (such as 23.6%, 38.2%, 50%, 61.8%, and 100%). These levels often coincide with potential [support and resistance](../s/support_and_resistance.md) zones.
...
Breakouts occur when the price moves beyond a support or resistance level, signaling a potential [trend](../t/trend.md) continuation. However, false breakouts are a common pitfall where the price temporarily moves beyond a level only to reverse shortly thereafter. Advanced [algorithmic trading](../a/algorithmic_trading.md) systems can distinguish between breakouts and false breakouts using additional indicators or [volume confirmation](../v/volume_confirmation.md).
