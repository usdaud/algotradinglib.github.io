...
2. **Upper and Lower Shadows**: Both shadows are typically longer than the real body, showing significant high and low points during the trading session.
...
1. Plot the open, high, low, and close prices for the session.
2. Draw a rectangle (the real body) between the open and close prices.
