...
#### Data Sources
Sources of data can be varied, including [market](../m/market.md) exchanges, financial news outlets, and specialized financial data providers like [Bloomberg](../b/bloomberg.md) [Reuters](../r/reuters.md) and [QuantConnect](../q/quantconnect.md)
...
#### Notable Platforms
- **[Alpaca](../a/alpaca.md) Provides API for [algorithmic trading](../a/algorithmic_trading.md) and [backtesting](../b/backtesting.md).
- **QuantInsti Offers courses and platforms for learning [quantitative trading](../q/quantitative_trading.md).
- **RiskWatch [Software tools](../s/software_tools_for_trading.md) for real-time [risk](../r/risk.md) monitoring and management.
