...
Two Sigma Investments is a prominent quantitative [hedge fund](../h/hedge_fund.md) that employs [data science](../d/data_science_in_trading.md) and technology to drive investment strategies. The [firm](../f/firm.md) relies heavily on quantitative [performance metrics](../p/performance_metrics.md) to evaluate its algorithms.
