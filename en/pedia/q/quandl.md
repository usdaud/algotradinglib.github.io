...
- **Data Scientists**: Enables data scientists to leverage [alternative data](../a/alternative_data.md) for [predictive modeling](../p/predictive_modeling.md) and machine learning applications.
