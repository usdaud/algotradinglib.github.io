...
## Overview
QuantRocket is a comprehensive platform for researching, [backtesting](../b/backtesting.md), and deploying [quantitative trading](../q/quantitative_trading.md) strategies. Designed for professional traders and quantitative analysts, QuantRocket provides robust data management, [backtesting](../b/backtesting.md) capabilities, and seamless integration with multiple brokers and data providers. It leverages a cloud-based infrastructure to offer scalable and powerful computational resources.

## Features
1. **Data Management**: Access to a wide variety of historical and [real-time market data](../r/real-time_market_data.md) across multiple asset classes.
...
- **Backtester**: Robust [backtesting](../b/backtesting.md) engine to simulate [trading strategies](../t/trading_strategies.md) using historical data.
...
- **[Risk Management](../r/risk_management.md) Module**: Real-time risk monitoring and management tools.
