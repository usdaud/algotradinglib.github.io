...
- Signal research using statistical methods.
- Backtesting with realistic costs and constraints.
- Execution and risk management automation.

## Common strategy types
- Trend following and momentum models.
- Mean reversion and statistical arbitrage.
- Factor based equity models.
- Event driven or news based models.
...
## Practical checklist
- Define the time horizon for Quant Trading and the market context.
...
## Common pitfalls
- Treating Quant Trading as a standalone signal instead of context.
