...
- **[Stochastic Calculus](../s/stochastic_calculus.md):** Used to model and predict the random movement of asset prices over time.
...
- **[Mean Reversion](../m/mean_reversion.md):** Betting that the price of an asset will revert to its historical mean.
- **[Pairs Trading](../p/pairs_trading.md):** Trading two correlated assets simultaneously, buying the undervalued and shorting the overvalued one.
...
- **Latency [Arbitrage](../a/arbitrage.md):** Exploiting the delay between the dissemination of market information and the reaction of other market participants.
- **Market Making:** Providing liquidity by simultaneously offering to buy and sell a security, earning a spread.

### Algorithmic Trading
[Algorithmic trading](../a/algorithmic_trading.md) involves using computer algorithms to automate the process of trading. These algorithms can be based on a wide range of strategies, including:
...
### University Programs
Numerous leading universities offer graduate programs in quantitative finance, [financial engineering](../f/financial_engineering.md), and related disciplines. Examples include:
