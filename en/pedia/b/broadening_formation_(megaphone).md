...
A broadening formation is a chart pattern characterized by higher highs and lower lows, creating a widening range that resembles a megaphone. It reflects increasing volatility and uncertainty.

## Structure
- Upper trend line slopes upward
- Lower trend line slopes downward
- Price swings grow larger over time

## Interpretation
The pattern suggests instability and lack of consensus. It can appear near market tops or during turbulent phases of a trend.

## Trading Considerations
Some traders treat the outer boundaries as support and resistance levels. Breakouts can be powerful but also prone to false moves due to volatility.

## Risks
The expanding range makes stop placement difficult and increases whipsaw risk. Position sizing should account for wider price swings.
