...
- **Virtu Financial** (Virtu Financial): One of the world's most widely recognized HFT firms.
- **Citadel Securities** (Citadel Securities): Another major player, renowned for its advanced [trading algorithms](../t/trading_algorithms.md) and [market](../m/market.md)-making practices.
...
- **Two Sigma** (Two Sigma): This [firm](../f/firm.md) employs advanced technologies to execute vast arrays of stat-arb strategies.
- **D.E. Shaw & Co.** (D.E. Shaw): Known for its rigorous scientific approach to stat-arb trading.
...
- **Kensho Technologies** (Kensho Technologies): A company specializing in AI for [financial markets](../f/financial_market.md).
- **AQR [Capital](../c/capital.md) Management** (AQR Capital Management): Integrating [machine learning](../m/machine_learning.md) models into their [trading strategies](../t/trading_strategies.md), AQR is a pioneer in [quantitative trading](../q/quantitative_trading.md).

## Quantitative Research Firms

[Quantitative research](../q/quantitative_research.md) firms apply rigorous academic research methodologies to discover new [trading strategies](../t/trading_strategies.md). These strategies are then coded into algorithms. Significant firms in this area include:

- **Jane Street** (Jane Street): Specializes in using [quantitative research](../q/quantitative_research.md) to [trade](../t/trade.md) equities, bonds, and cryptocurrencies.
- **Renaissance Technologies** (Renaissance Technologies): Known for the Medallion [Fund](../f/fund.md), one of the most successful [quantitative hedge funds](../q/quantitative_hedge_funds.md).
...
- **BlackRock** (BlackRock): A leader in ETFs, under its [iShares](../i/ishares.md) brand, leveraging algorithmic tools.
- **State Street Global Advisors** (State Street Global Advisors): Another prominent player in ETFs and [index arbitrage](../i/index_arbitrage.md).
...
- **Liquidnet** (Liquidnet): Provides institutional traders with [dark pool](../d/dark_pool.md) facilities for large trades.
- **ITG (Investment Technology Group)** (ITG): Renowned for its POSIT [dark pool](../d/dark_pool.md), which enables efficient [trade](../t/trade.md) matching.
...
- **ITG (Investment Technology Group)** (ITG): Offers [robust](../r/robust.md) TCA tools to evaluate [trading performance](../t/trading_performance.md).
- **[Bloomberg](../b/bloomberg.md) Tradebook** (Bloomberg Tradebook): Supplies comprehensive TCA analytics for traders.
...
- **NICE Actimize** (NICE Actimize): Specializes in regulatory compliance and financial crime prevention.
- **AxiomSL** (AxiomSL): Provides platforms that help financial institutions manage regulatory reporting and compliance.
...
- **Tower Research [Capital](../c/capital.md)** (Tower Research Capital): Engages deeply in [market](../m/market.md) making and [liquidity provision](../l/liquidity_provision.md).
- **[Jump Trading](../j/jump_trading.md)** (Jump Trading): Known for its expertise in trading technologies and [market](../m/market.md) structure.
...
- **[Coinbase](../c/coinbase.md) Pro** (Coinbase Pro): Employs advanced algorithms for large-scale crypto trading.
- **[Binance](../b/binance.md)** (Binance): One of the largest cryptocurrency exchanges utilizes algorithmic tools for [market](../m/market.md) making and trading operations.
...
- **Numerix** (Numerix): Offers cutting-edge [risk management](../r/risk_management.md) solutions powered by sophisticated algorithms.
- **Algorithmics (an IBM Company)** (Algorithmics): Specializes in [risk](../r/risk.md) analytics and [portfolio management](../p/par.md) tools.
...
- **MetaTrader** (MetaTrader): Provides a comprehensive platform for algorithmic Forex and CFD trading.
- **Trading Technologies** (Trading Technologies): Supplies professional-grade tools that integrate [data analytics](../d/data_analytics.md) with [trade](../t/trade.md) [execution](../e/execution.md).
...
- **IBM Quantum** (IBM Quantum): Pioneer in advancing quantum technologies for various applications, including [finance](../f/finance.md).
- **Google Quantum AI** (Google Quantum AI): Exploring [quantum computing](../q/quantum_computing_in_trading.md)'s applications across diverse sectors, including trading.
...
- **Uniswap** (Uniswap): A leading decentralized [exchange](../e/exchange.md) that uses [smart contracts](../s/smart_contracts_in_trading.md) to facilitate automated [liquidity provision](../l/liquidity_provision.md).
- **Aave** (Aave): Provides decentralized lending and borrowing services, with algorithms managing [collateral](../c/collateral.md) and [interest](../i/interest.md) rates.
...
- **DeepMind** (DeepMind): Although known for AI research, there is potential for financial [market](../m/market.md) applications.
- **[Alpaca](../a/alpaca.md)** (Alpaca): Specializes in API-based trading platforms that [leverage](../l/leverage.md) [machine learning](../m/machine_learning.md) for better [trade](../t/trade.md) [execution](../e/execution.md).
