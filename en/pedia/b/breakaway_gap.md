...
A breakaway gap is a price gap that occurs when a market moves out of a consolidation range or chart pattern. It often marks the start of a new trend.

## Characteristics
- Appears after a well-defined trading range or pattern
- Volume often increases during the gap
- Price tends not to fill the gap quickly

## Trading Use
Traders may enter in the direction of the gap with stops near the gap area. The gap can also serve as a new support or resistance zone.

## Risks
Not all gaps are breakaway gaps. False breakouts can occur, especially during low liquidity or news-driven spikes.
