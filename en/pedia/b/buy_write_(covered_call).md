...
A buy write, also called a covered call, is an options strategy that combines a long stock position with a short call option on the same stock. It generates option premium income in exchange for capping upside.

## Structure
- Buy or hold the underlying stock
- Sell a call option with a chosen strike and expiration

## Payoff Profile
- Limited upside above the call strike
- Premium received provides a small buffer against downside
- Downside risk remains similar to owning the stock

## Use Cases
Buy writes are used to generate income in flat or mildly bullish markets. They can also reduce portfolio volatility by converting part of expected returns into option premium.

## Risks
The strategy limits upside if the stock rallies strongly. If the stock declines sharply, the premium only partially offsets losses.
