...
Discretionary strategies depend on human judgment and expertise to make investment decisions. Portfolio managers and analysts use their knowledge, experience, and intuition to evaluate investment opportunities.
...
Investing in distressed securities involves targeting companies facing financial difficulties. The rationale is that these securities may be undervalued due to temporary issues, and significant returns can be achieved if the company's fortunes improve.
...
Pair trading is a market-neutral strategy where two correlated securities are traded simultaneously – one long and one short. The idea is to profit from the relative price movements between the two securities.
...
High-Frequency Trading involves executing a large number of orders at extremely high speeds. HFT strategies capitalize on small price discrepancies and rely heavily on sophisticated technology and low-latency execution.

### Market Making

Market making involves providing liquidity to the market by continuously quoting buy and sell prices for a particular security. Market makers profit from the spread between the bid and ask prices.
...
Implementation shortfall aims to minimize the difference between the decision price and the execution price. The trading algorithm dynamically adjusts its strategy based on market conditions to achieve an optimal balance between speed and cost.

### Volume-Weighted Average Price (VWAP)

VWAP strategies break down large orders into smaller trades executed throughout the day at prices close to the average market price. The goal is to minimize the impact on the market and achieve an execution price close to the VWAP.
...
Buy side firms must comply with stringent regulatory requirements governing market conduct, reporting, and investor protection. Regulatory frameworks vary across jurisdictions and require ongoing monitoring and adaptation.
