...
A bear flag is a bearish continuation pattern that forms after a sharp downward move (the flagpole) followed by a brief upward or sideways consolidation (the flag). It suggests that sellers are pausing before potentially resuming the downtrend.

## Structure
- Strong decline creates the flagpole
- Price consolidates in a small upward-sloping channel or tight range
- Breakdown from the flag resumes the downtrend

## Confirmation
Traders often look for:
- A breakdown below the lower boundary of the flag
- Increased volume on the breakdown
- Alignment with broader trend or market weakness

## Risks
False breakouts can occur if the consolidation expands into a larger range. Tight stops are commonly placed above the flag to control risk.
