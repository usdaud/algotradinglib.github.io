...
A broken wing butterfly is an options strategy similar to a butterfly spread but with uneven wing widths. The structure shifts risk and reward to create a wider profit zone or a credit entry.

## Structure
A typical call broken wing butterfly uses:
- Buy 1 call at a lower strike
- Sell 2 calls at a middle strike
- Buy 1 call at a higher strike, but farther away than the lower wing

The uneven wings create an asymmetric payoff profile.

## Payoff Profile
- Limited risk on one side
- Wider or shifted profit zone compared to a standard butterfly
- Can be opened for a credit, reducing downside risk

## Use Cases
Traders use broken wing butterflies when they have a directional bias but want defined risk and a potentially higher probability of profit.

## Risks
Risk exists beyond the broken wing side, though it is still defined. Assignment and early exercise can affect results if short options move in the money.
