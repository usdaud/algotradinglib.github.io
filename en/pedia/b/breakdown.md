...
A breakdown is a price move below a significant support level or a key technical boundary. It signals potential continuation of a downtrend or a shift in market sentiment.

## Identification
- Price closes below support
- Volume increases on the break
- Prior support may turn into resistance on a retest

## Trading Approach
Traders may enter short positions on the break or on a retest of the broken support. Risk is often controlled with stops above the prior support zone.

## Limitations
Breakdowns can fail if the move lacks volume or occurs in a broader uptrend. False breakdowns are common in range-bound markets.
