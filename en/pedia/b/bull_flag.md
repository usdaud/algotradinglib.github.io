...
A bull flag is a bullish continuation pattern that forms after a sharp upward move (the flagpole) followed by a short consolidation that slopes slightly downward or moves sideways.

## Structure
- Strong upward price move forms the pole
- Consolidation forms a small channel or rectangle
- Breakout above the flag signals continuation

## Trading Approach
Entries are often taken on a breakout with stops below the flag. Targets can be estimated by projecting the pole length upward from the breakout.

## Limitations
False breakouts can occur if volume does not confirm the move or if the broader trend weakens.
