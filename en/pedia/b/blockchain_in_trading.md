...
Blockchain has given rise to Decentralized Exchanges (DEXs), which operate without a central authority, allowing users to [trade](../t/trade.md) directly with each other. DEXs [offer](../o/offer.md) increased [security](../s/security.md) and privacy as they do not [hold](../h/hold.md) users’ funds, unlike centralized exchanges.
