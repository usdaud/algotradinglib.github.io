...
A buy on close order is an instruction to purchase a security at the closing price. The order is executed during the closing auction or the final trading print.

## Use Cases
- Index fund rebalancing
- Portfolio marking and end of day allocations
- Strategies that use closing prices for signals

## Execution Considerations
Execution depends on auction liquidity and order imbalances. Large buy-on-close orders can influence the closing price if market depth is limited.

## Risks
The closing price can be volatile due to concentrated order flow. Traders should account for potential slippage and partial fills in thin markets.
