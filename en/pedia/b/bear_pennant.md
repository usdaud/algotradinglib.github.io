...
A bear pennant is a bearish continuation pattern that occurs after a sharp decline followed by a brief consolidation with converging trend lines. It represents a short pause before a possible continuation lower.

## Structure
- Strong downward move creates the pole
- Consolidation forms a small triangle or pennant
- Breakdown from the lower boundary signals continuation

## Trading Approach
Traders often enter on the breakdown with a stop above the pennant. Targets are sometimes measured by projecting the length of the prior pole downward.

## Limitations
Pennants can fail if broader market sentiment shifts or if the consolidation drifts too long. Low volume during the breakout can reduce reliability.
