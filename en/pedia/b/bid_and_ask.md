...
### Example Platform
NASDAQ TotalView, which is a window into the dynamic buying and selling action on [NASDAQ](../n/nasdaq.md).
...
### Example Company
Jane Street is a well-known [firm](../f/firm.md) in the [quantitative trading](../q/quantitative_trading.md) and
...
### Example Platform
[Bloomberg](../b/bloomberg.md) offers real-time financial news that can be integrated into [algorithmic trading](../a/accountability.md) models.
