...
3. **Statistical Arbitrage Patterns**:
   ...
   - Pairs trading, a type of statistical arbitrage, involves trading long in one security and short in another related security.
...
1. **Supervised Learning**:
   ...
   - Techniques include decision trees, support vector machines (SVM), and neural networks.
...
1. **MetaTrader**:
   - Provides numerous built-in technical indicators and pattern recognition tools.
...
3. **Bloomberg Terminal**:
   ...
   - Includes modules for technical analysis and pattern recognition.
...
2. **AQR Capital Management**:
   - Uses quantitative models that include pattern recognition techniques to manage a variety of investment strategies.
