...
The creation of price-[weighted](../w/weighted.md) indices like the DJIA made sense historically when technology and computational resources were limited. Adding and averaging stock prices was relatively straightforward for manual calculations. However, with the advent of advanced computing, more sophisticated methods such as [market](../m/market.md)-cap-weighting have become preferred for many newer indices due to their ability to more accurately reflect the [underlying](../u/underlying.md) economic variables.
...
- **Price-[Weighted](../w/weighted.md):** Dow Jones Industrial Average (DJIA)
- **[Market](../m/market.md)-Cap-[Weighted](../w/weighted.md):** S&P 500, [NASDAQ](../n/nasdaq.md)-100
...
- **[Market](../m/market.md)-Cap-[Weighted](../w/weighted.md) Indices:** Adjustments mainly involve changes in the constituent companies and do not require recalculating a divisor.

### Applicability

- **Price-[Weighted](../w/weighted.md) Indices:** More applicable for traditional, historical analyses and for indices with a smaller number of large, high-priced [stocks](../s/stock.md).
- **[Market](../m/market.md)-Cap-[Weighted](../w/weighted.md) Indices:** Preferred for broader [market](../m/market.md) representations and analytically intensive financial products like ETFs and mutual funds.
...
Given these criticisms, many modern indices prefer [market](../m/market.md)-cap-weighting or other methodologies like equal-weighting or fundamentally-[weighted](../w/weighted.md) approaches.
