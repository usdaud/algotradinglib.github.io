...
PDI specifically addresses how a society handles inequalities among people. A high PDI indicates that society accepts hierarchical [order](../o/order.md) without much question, whereas a low PDI indicates that people strive to equalize the [distribution](../d/distribution.md) of power and [demand](../d/demand.md) justification for inequalities of power.
...
In countries with low PDI, inequalities in power and [wealth](../w/wealth.md) are minimalized and questioned. There is a preference for participation, questioning authority, and equal [distribution](../d/distribution.md) of power. Examples of low PDI countries include Austria, Israel, Denmark, and New Zealand.
...
Hofstede’s PDI scores also show a fascinating [correlation](../c/correlation.md) with national cultures, affecting how businesses operate on a broader scale. Understanding these national cultural dimensions is crucial for multinational enterprises working in cross-cultural environments.
...
2. **New Zealand**: Similarly, New Zealand’s low PDI is reflected in its egalitarian approach and the importance placed on individual contributions and [open](../o/open.md) discussion in [business](../b/business.md) settings.

## PDI in Organizational Behavior and Leadership

PDI has profound implications on organizational behavior and [leadership](../l/leadership.md) styles. Understanding PDI helps organizations tailor their management approaches to match cultural expectations and increase [efficiency](../e/efficiency.md).

### Leadership

- **High PDI**: Leaders are seen as decisiveness and assertive. Autocratic [leadership](../l/leadership.md) is more common, where decisions are made by those at the top levels without extensive consultation with subordinates.

- **Low PDI**: Leaders are facilitators rather than directors. They work collaboratively with employees and [value](../v/value.md) consensus in decision-making.
...
3. **Survey Data**: Hofstede’s original data was based on surveys from a single [multinational corporation](../m/multinational_corporation.md) (IBM). This dataset might not comprehensively represent broader national cultures or other industries.
