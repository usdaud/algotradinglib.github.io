...
## Structure
- A long tail or wick showing rejection.
- A small body near the opposite end.
- The long wick is typically at least two thirds of the total range.
...
## Practical checklist
- Define the time horizon for Pin Bar and the market context.
...
## Common pitfalls
- Treating Pin Bar as a standalone signal instead of context.
