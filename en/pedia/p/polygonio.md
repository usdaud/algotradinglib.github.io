...
## Overview
Polygon.io is a financial market data platform that offers real-time and historical data for stocks, options, forex, and cryptocurrencies. Known for its high-performance APIs, Polygon.io provides developers, traders, and financial institutions with reliable and scalable data solutions to power [trading algorithms](../t/trading_algorithms.md), financial applications, and research projects.

## Features
1. **[Real-Time Market Data](../r/real-time_market_data.md)**: Provides fast and accurate real-time data for equities, options, forex, and cryptocurrencies.
...
- **Trading Platforms**: Compatibility with popular trading platforms such as MetaTrader, [NinjaTrader](../n/ninjatrader.md), and [TradingView](../t/tradingview.md).
...
- **Custom Applications**: API access for developing custom financial applications and [trading systems](../t/trading_systems.md).
...
## Use Cases
- **Algorithmic Traders**: Utilized by algo traders for developing, [backtesting](../b/backtesting.md), and deploying automated [trading strategies](../t/trading_strategies.md) using real-time and historical data.
- **Quantitative Analysts**: Supports quants in analyzing market trends and testing [trading models](../t/trading_models.md) with high-quality data.
