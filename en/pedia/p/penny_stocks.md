...
### Characteristics
1. **Low Price**: Trade below $5 per share.
2. **Low Market Capitalization**: Typically, these companies have a market cap of fewer than $200 million.
3. **Volatility**: High volatility due to lower liquidity and limited trading volume.
4. **Lack of Reporting Requirements**: Many penny stocks trade on the OTC (Over The Counter) markets, which have fewer reporting requirements compared to major exchanges like NASDAQ or NYSE.

### Markets
1. **OTC Markets**: Penny stocks primarily trade on the Over-The-Counter (OTC) Bulletin Board, Pink Sheets, and the OTCQX and OTCQB markets.
...
2. **Ethics**: Avoiding market manipulation and ensuring fair trading practices.
...
### Examples
1. **Quant Funds**: Hedge funds leveraging high-frequency trading (HFT) algorithms.
