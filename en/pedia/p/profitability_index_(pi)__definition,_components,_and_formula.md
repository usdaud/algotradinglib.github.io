...
- **Useful for Capital Rationing:**
  - In scenarios where capital is limited, PI helps in selecting the best combination of projects that maximize returns.
...
- **Ignores Scale of Investment:**
  - PI does not consider the absolute size of the profit generated by the project, which can sometimes be important in decision-making.

- **Discount Rate Sensitivity:**
  - PI is sensitive to the chosen discount rate. A small change in the discount rate can significantly impact the PI value.
