...
Portfolio diversification is a [risk management](../r/risk_management.md) strategy that mixes a wide variety of investments within a portfolio. The rationale is that a diversified portfolio will, on average, yield higher returns and pose a lower risk than any individual investment found within the portfolio. Diversification strives to smooth out unsystematic risks in a portfolio, so the positive performance of some investments neutralizes the negative performance of others.
...
2. **Correlation**
   ...
   - **Strategy**: By mixing assets that have low or negative correlation, investors can mitigate risk. When one asset category encounters difficulties, another may benefit, allowing for a more balanced performance overall.

3. **Investment Types Mentioned**
   - **Stocks**: Represent ownership in a company and constitute a claim on part of the corporation's assets and earnings.
   - **Bonds**: Essentially loans made to large organizations (such as corporations or governments), with an agreement to pay back the principal along with interest.
   - **Real Estate**: Property consisting of land and the buildings on it, as well as natural resources such as crops, minerals, or water.
   - **Commodities**: Basic goods used in commerce that are interchangeable with other goods of the same type, like gold, oil, or grain.
   - **Mutual Funds/ETFs**: Investment vehicles that pool together money from many investors to purchase a diversified portfolio of stocks, bonds, or other securities.
...
4. **Liquidity**
   - Some assets, like real estate or certain bonds, may not be easily liquidated or may have high transaction fees, affecting portfolio flexibility.
