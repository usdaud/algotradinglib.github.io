...
A patent is a form of intellectual property that grants the patent holder exclusive rights to an invention or process for a specific period, typically 20 years from the filing date. This exclusivity allows the patent holder to prevent others from making, using, selling, or importing the patented invention without permission. Patents play a crucial role in encouraging innovation by providing inventors with time-limited monopolies in [exchange](../e/exchange.md) for public [disclosure](../d/disclosure.md) of their inventions.

## Types of Patents

There are three main types of patents:

1. **[Utility](../u/utility.md) Patents**: These protect new and useful processes, machines, articles of manufacture, or compositions of matter. [Utility](../u/utility.md) patents are the most common type and are often what people think of when they refer to patents.
...
2. **Filing**: The completed patent application is filed with the relevant patent office. In the United States, this is the United States Patent and [Trademark](../t/trademark.md) Office (USPTO). The filing date is crucial and can affect the rights of the patent holder.
...
3. **[Utility](../u/utility.md)**: The invention must be useful and have a specific, substantial, and credible [utility](../u/utility.md).

4. **Adequate [Disclosure](../d/disclosure.md)**: The patent application must sufficiently disclose the invention to enable others skilled in the field to replicate it.
...
3. **Account of Profits**: An [order](../o/order.md) requiring the infringer to pay the patent holder the profits made from the infringing activities.
...
2. **[Assignment](../a/assignment.md)**: The patent holder transfers ownership of the patent to another party. The assignee then gains all the rights associated with the patent.
...
2. **Patent Cooperation Treaty (PCT)**: This treaty allows inventors to file a single international patent application, which can then be pursued in [multiple](../m/multiple.md) member countries.
...
While patents require [disclosure](../d/disclosure.md) of the invention, [trade](../t/trade.md) secrets involve keeping the details confidential. Both [offer](../o/offer.md) means of protecting intellectual property, but they have different implications:

1. **[Disclosure](../d/disclosure.md) vs. Secrecy**: Patents require full [disclosure](../d/disclosure.md), while [trade](../t/trade.md) secrets rely on maintaining confidentiality.

2. **Durability**: Patents have a fixed term (usually 20 years), after which the information enters the public domain. [Trade](../t/trade.md) secrets can last indefinitely, provided the information remains confidential.

## Impact of Patents on Innovation

Patents have a complex relationship with innovation. They encourage inventors by providing a period of exclusive rights, incentivizing investment in research and development. On the other hand, overly broad or numerous patents can stifle innovation by creating [barriers to entry](../b/barriers_to_entry.md) and increasing the [risk](../r/risk.md) of litigation.
...
Patenting in the fintech [industry](../i/industry.md) faces specific challenges, including:
...
1. **Greater Clarity on Software Patents**: Legal standards for patenting software and algorithms are likely to continue evolving, potentially becoming more lenient as technologies like [artificial intelligence](../a/artificial_intelligence_in_trading.md) advance.
