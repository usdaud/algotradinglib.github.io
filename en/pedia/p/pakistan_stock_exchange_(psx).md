...
1. **Trend Following:** Algorithms detect market trends and execute trades aligned with those trends.
2. **Arbitrage:** Exploiting price differences between markets or instruments.
3. **Mean Reversion:** Trading based on the assumption that prices will revert to their historical mean.
