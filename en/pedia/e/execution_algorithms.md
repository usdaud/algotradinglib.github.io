...
5. **[Liquidity](../l/liquidity.md)-Seeking Algorithms**
 ...
 - **Real-World Example**: UBS\'s AES (Advanced [Execution](../e/execution.md) Services) includes [liquidity](../l/liquidity.md)-seeking algorithms (formerly Credit Suisse, acquired March 2023).
...
- UBS AES (formerly Credit Suisse, acquired March 2023)
- Trade Informatics
