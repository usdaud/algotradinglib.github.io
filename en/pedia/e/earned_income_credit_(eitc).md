...
1. **Relationship Test**: The child must be the taxpayer’s son, daughter, stepchild, foster child, or a descendant of any of them. The child can also be the taxpayer's brother, sister, stepbrother, stepsister, or a descendant of any of them.
...
4. **Joint Return Test**: The child cannot file a joint return for the year unless they did so only to claim a refund.
