...
- **Amazon**: An e-[commerce](../c/commerce.md) giant [offering](../o/offering.md) a vast [range](../r/range.md) of products and services worldwide Amazon.
- **eBay**: An online marketplace where individuals and businesses can buy and sell various goods and services eBay.
- **Alibaba**: A leading Chinese e-[commerce](../c/commerce.md) platform that connects manufacturers with buyers around the world Alibaba.
...
- **Alibaba**: Apart from B2C, Alibaba also plays a significant role in B2B transactions Alibaba.
- **ThomasNet**: This platform serves as an industrial marketplace for manufacturers and buyers ThomasNet.
...
- **eBay**: Also a prominent platform for C2C, where individuals can auction items or sell them directly eBay.
- **Craigslist**../s/sale.md) Craigslist.
...
- **Upwork**: Connects freelancers with businesses looking to hire for various services Upwork.
...
- **Shopify**: A widely-used platform that enables businesses to create online stores Shopify.
- **Magento**: An [open](../o/open.md)-source e-[commerce](../c/commerce.md) platform with flexible cloud solutions Magento.
- **WooCommerce**: An [open](../o/open.md)-source e-[commerce](../c/commerce.md) plugin for WordPress WooCommerce.
