...
Quantitative tools and models are essential for measuring long [tail risk](../t/tail_risk.md). These include Value at Risk (VaR), Conditional Value at Risk (CVaR), and stress testing.
...
### Axioma
Axioma, a part of Qontigo, provides portfolio and [risk management](../r/risk_management.md) solutions. Their software includes advanced risk models that account for long tail risks, helping traders to optimize their portfolios and mitigate potential losses.
