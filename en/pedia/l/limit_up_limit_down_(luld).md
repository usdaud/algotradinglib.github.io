...
## How it works
- A reference price is calculated from recent trades.
- Upper and lower bands are set at a fixed percentage around the reference.
- If trading would occur outside the bands, a trading pause can be triggered.
...
## Practical checklist
- Define the time horizon for Limit Up Limit Down (LULD) and the market context.
...
## Common pitfalls
- Treating Limit Up Limit Down (LULD) as a standalone signal instead of context.
