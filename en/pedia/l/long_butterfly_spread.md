...
- **Buy 1 Call with a strike price of $110** (higher strike)
...
- **Buy 1 Put with a strike price of $110** (higher strike)
...
2. **Higher Breakeven Point:**
   \[ \text{Higher Strike Price} - \text{Net Premium Paid} \]
...
- **TD Ameritrade:** [TD Ameritrade](https://www.tdameritrade.com/) provides [thinkorswim](../t/thinkorswim.md), a trading platform with advanced options analytics tools.
