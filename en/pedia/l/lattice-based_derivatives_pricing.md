...
- **[StockSharp](../s/stocksharp.md)**: A platform providing [algorithmic trading](../a/algorithmic_trading.md) and [backtesting](../b/backtesting.md) engines that integrate various financial models, including lattice-based approaches.
