...
LIBOR is calculated for five currencies: the US dollar (USD), the euro (EUR), the British pound sterling (GBP), the Japanese yen (JPY), and the Swiss franc (CHF). Furthermore, it takes into account seven different maturities: overnight, one week, and 1, 2, 3, 6, and 12 months. This results in a total of 35 different LIBOR rates being published each business day.

### Determination Process
Each day, a panel of banks submits their estimated interest rates. These submissions represent the rates at which they believe they could borrow funds from other banks. The rates are then subject to a trimming process: the highest and lowest submissions are excluded, and the remaining rates are averaged to determine the LIBOR for each currency and maturity. The Intercontinental Exchange (ICE) Benchmark Administration currently oversees this process.
...
In 2012, it was revealed that some banks had manipulated their LIBOR submissions to profit from trading positions or make themselves appear more creditworthy than they were. This scandal highlighted significant deficiencies in the governance and reliability of LIBOR and led to regulatory overhauls.

### Legal and Financial Impact
The scandal resulted in substantial fines for implicated banks and led to widespread litigation. Furthermore, it prompted calls for more robust and transparent benchmark rates.
...
- **Secured Overnight Financing Rate (SOFR):** The preferred alternative in the United States, based on transactions in the Treasury repurchase market.
- **Sterling Overnight Index Average (SONIA):** The UK has adopted SONIA, which is based on actual overnight funding rates in the sterling market.
- **Euro Short-Term Rate (€STR):** The European Central Bank has introduced €STR as the eurozone alternative.
...
- **Market Adoption:** Ensuring widespread market acceptance and liquidity for new benchmarks.
...
## Conclusion
The transition away from LIBOR marks a significant shift in the financial markets. As the industry adapts to new benchmarks, it aims to foster a more transparent and stable financial environment. Stakeholders must stay informed and proactive to navigate this change effectively.
