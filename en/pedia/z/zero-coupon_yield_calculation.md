...
- **Issued at a Discount:** Zero-coupon bonds are sold at a discount to their face (par) value.
- **Single Payment:** The bond is redeemed at its face value at maturity.
- **No Reinvestment Risk:** Since there are no periodic interest payments, investors are not faced with reinvestment risk.
- **Priced on Compounding Interest:** The price appreciation reflects the effect of compounding interest over time.
...
The zero-coupon yield can be calculated using the following formula:
\[ 
