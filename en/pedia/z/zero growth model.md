...
1. **Constant Dividends**: The dividend payments remain constant and don't grow over time.
2. **Infinite Time Horizon**: The company is expected to continue operating indefinitely, paying the same dividend.
3. **Constant Required Rate of Return**: The rate of return required by investors does not change.
...
1. **Expected Dividend (D)**: This is usually derived from the company's historical dividend payments.
2. **Required Rate of Return (r)**: This can be estimated using the Capital Asset Pricing Model (CAPM), which considers the risk-free rate, the stock’s beta, and the equity market premium.
