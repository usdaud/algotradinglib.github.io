...
3. **[Risk Management](../r/risk_management.md)**: Constantly reassessing exposure and adjusting positions to negate risks within the same trading session.
...
3. **[Capital Allocation](../c/capital_allocation.md)**: Reviewing and redistributing capital based on [trading performance](../t/trading_performance.md) and market conditions.
...
- **[Order Management Systems](../o/order_management_systems.md) (OMS)**: Coordinate order placements across multiple markets.
  - Example: FlexTrade (https://flextrade.com) offers robust OMS capabilities.
- **[Portfolio Management](../p/portfolio_management.md) Systems (PMS)**: Handle allocations and [risk management](../r/risk_management.md).
  - Example: SimCorp Dimension (https://www.simcorp.com) is suitable for complex, multi-asset [portfolio management](../p/portfolio_management.md).
- **[Clearing and Settlement](../c/clearing_and_settlement.md) Systems**: Automate reconciliation processes.
