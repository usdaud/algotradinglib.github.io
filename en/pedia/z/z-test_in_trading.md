...
- \(H_0\): The mean return of the new algorithm (\(\mu_1\)) is equal to the mean return of the existing algorithm (\(\mu_2\)).
- \(H_1\): The mean return of the new algorithm (\(\mu_1\)) is different from the mean return of the existing algorithm (\(\mu_2\)).
...
- The variance (standard deviation) of the populations should be known and ideally equal.
