...
1. **Market Risk ([Systematic Risk](../s/systematic_risk.md))**: This type of uncertainty is inherent to the entire market or a particular market segment. Factors causing market risk include economic downturns, political instability, changes in interest rates, natural disasters, and [geopolitical events](../g/geopolitical_events.md). Market risk is omnipresence and cannot be completely eliminated through diversification.
...
4. **[Liquidity Risk](../l/liquidity_risk.md)**: [Liquidity risk](../l/liquidity_risk.md) refers to the uncertainty associated with the ease of buying or selling an asset. In illiquid markets, large transactions may not be executed promptly without impacting the asset's price.

5. **Model Risk**: In [algorithmic trading](../a/algorithmic_trading.md), model risk is the risk that the algorithm or the model used does not perform as expected due to errors in the model or underlying assumptions. This can lead to significant financial losses.

6. **Regulatory Risk**: Changes in laws and regulations can significantly impact [trading strategies](../t/trading_strategies.md). These include new regulations on high-frequency trading, transaction taxes, or changes in bankruptcy or derivative laws.
...
3. **[Geopolitical Events](../g/geopolitical_events.md)**: Events such as elections, wars, and international treaties impact markets unpredictably. The outcomes and subsequent market reactions are sources of significant uncertainty.
...
1. **Volatility**: One of the primary metrics used to quantify uncertainty in trading. [Historical volatility](../h/historical_volatility.md) measures past market movements, whereas implied volatility gauges market expectations of future volatility. Instruments like the VIX index are often used to measure market volatility.
...
3. **Expected Shortfall (CVaR)**: It provides an estimate of the expected loss in the worst-case scenario beyond the VaR threshold, offering a more comprehensive measure of [tail risk](../t/tail_risk.md).
...
2. **Hedging**: Using [derivatives](../d/derivatives.md) like options, futures, and swaps to mitigate potential losses from unfavorable price movements.
...
2. **Brexit Referendum**: The unexpected outcome of the UK's Brexit referendum in June 2016 led to sharp movements in currency, stock, and bond markets globally, showcasing the impact of [geopolitical events](../g/geopolitical_events.md) on trading uncertainty.
