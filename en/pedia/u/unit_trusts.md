...
**Unit Trusts** are a type of collective investment constituted under a trust deed. They pool funds from numerous investors to invest in a diversified portfolio of securities. Each investor owns units, which represent a portion of the holdings of the trust. The primary objective of a unit trust is to diversify investment risk and to provide investors with professional fund management.
...
A unit trust has a unique structure built around the relationship between its key players, which includes the trustee, the fund manager, and the unitholders:

1. **Trustee**: The trustee is a financial institution or a trust company responsible for holding the trust's assets on behalf of the unitholders and ensuring that the fund manager complies with the trust deed.

2. **Fund Manager**: The fund manager is responsible for the day-to-day management of the unit trust. This includes making investment decisions, buying and selling assets, and adjusting the portfolio as per the trust deed's guidelines and the investment strategy.

3. **Unitholders**: These are the investors who contribute money to the unit trust and, in return, receive units representing their share of ownership in the trust's portfolio.

### Valuation and Pricing

The unit trust's NAV is calculated by subtracting the trust's liabilities from its total assets and dividing the result by the number of units outstanding. The NAV per unit is vital for pricing and transactional purposes. Units in the trust can be bought or sold at prices related to the NAV.
...
2. **Cost Reduction**: Automation reduces the need for manual intervention, lowering transaction costs and reducing the likelihood of human errors.
...
1. **Technical Complexity**: Developing and maintaining sophisticated algorithms requires substantial technical expertise and investment in infrastructure.
