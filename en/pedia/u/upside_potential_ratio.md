...
\[ \text{UPR} = \frac{\text{Expected [Upside Potential](../u/upside_potential_in_trading.md)}}{\text{Downside Risk}} \]

Where:

- **Expected [Upside Potential](../u/upside_potential_in_trading.md)** is the expected return above the MAR.
...
4. **Apply the UPR Formula:** Divide the [upside potential](../u/upside_potential_in_trading.md) by the downside risk.
...
2. **Limited Downside Focus:** By emphasizing [upside potential](../u/upside_potential_in_trading.md), the UPR might underrepresent true portfolio risk if significant downside threats are present.

### Practical Applications in Algorithmic Trading

Algorithmic traders can leverage UPR to refine their [trading strategies](../t/trading_strategies.md) and enhance [portfolio optimization](../p/portfolio_optimization.md) by focusing on algorithms that exhibit strong [upside potential](../u/upside_potential_in_trading.md) relative to their threshold for acceptable performance. The UPR can inform:
