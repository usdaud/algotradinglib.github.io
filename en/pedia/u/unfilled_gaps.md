...
A gap occurs when the opening price of a security differs from its closing price on the previous trading day. This results in a visible gap on the price chart. Gaps can occur in any timeframe, from intraday to daily or even weekly charts, and they are typically classified into several types, including common gaps, breakaway gaps, runaway (or measuring) gaps, and exhaustion gaps.
...
2. **Breakaway Gap**: These occur at the end of a price pattern or during a breakout. They signify the beginning of a new trend and are often associated with high volume.

3. **Runaway Gap**: Also known as continuation gaps, these occur in the middle of a strong trend. They indicate a surge of interest and often remain unfilled for a longer period.

4. **Exhaustion Gap**: Found at the end of a trend, these gaps indicate the final thrust of buying or selling pressure. They are usually followed by a reversal.

## Unfilled Gaps

Unfilled gaps, also known as open gaps, occur when the price does not retrace to fill the gap created by the initial price movement. These gaps can be indicative of strong market sentiment and are often used by traders to predict future price movements. Unfilled gaps can provide insight into market direction, momentum, and potential reversals.
...
4. **Long-term Implications**: Gaps that remain unfilled for extended periods can have long-term implications, providing clues about underlying market strength.
...
While unfilled gaps present lucrative opportunities, they also come with inherent risks and challenges. Algorithmic traders must be aware of these factors to mitigate potential losses.
...
Markets can be highly volatile, and gaps can sometimes be the result of unexpected news or events. Algorithmic systems must be able to adapt to changing market conditions and quickly reassess positions in response to new information.
...
In August 2020, Tesla (TSLA) experienced a significant runaway gap during its upward trend. The gap occurred after the company announced a stock split, leading to a substantial increase in buying interest. The gap remained unfilled for several weeks, indicating strong bullish sentiment. Algorithmic traders who identified this unfilled gap and traded in the direction of the trend profited from the continued price increase.

### Example 2: Breakaway Gap in Apple (AAPL)

In April 2021, Apple (AAPL) exhibited a breakaway gap following a strong earnings report. The stock opened significantly higher, creating a gap that remained unfilled for an extended period. Algorithmic traders leveraging gap scanning tools could identify this unfilled gap and capitalize on the subsequent upward trend, aligning their trades with the prevailing market sentiment.

## Best Practices for Implementing Gap Trading Algorithms

To effectively implement algorithms that trade unfilled gaps, traders should follow these best practices:
...
Algorithmic systems should continuously monitor the market for new gaps and reassess existing positions in real-time. Ensuring that the system adapts to changing market conditions is crucial for maintaining profitability.
