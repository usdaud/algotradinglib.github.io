...
## Overview
Upstox is a leading discount brokerage firm in India, providing a wide range of financial services, including [equity trading](../e/equity_trading.md), [derivatives](../d/derivatives.md) trading, commodities, mutual funds, and IPOs. Known for its competitive pricing, advanced trading platforms, and robust customer support, Upstox caters to both retail and institutional investors.

## Features
1. **Wide Range of Instruments**: Access to equities, [derivatives](../d/derivatives.md), commodities, mutual funds, and IPOs.
2. **Advanced Trading Platforms**: Offers multiple trading platforms, including Upstox Pro Web, Upstox Pro Mobile, and Upstox API for automated trading.
...
## Key Components
- **Upstox Pro Web**: A user-friendly trading platform offering advanced charting, real-time data, and a range of trading tools.
- **Upstox Pro Mobile**: Mobile application for trading, account management, and market research on the go.
