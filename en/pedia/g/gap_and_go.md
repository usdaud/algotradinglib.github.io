...
- The stock gaps significantly above or below the prior close.
- Pre market volume and news support the move.
- The opening range shows brief consolidation rather than immediate reversal.
...
## Practical checklist
- Define the time horizon for Gap And Go and the market context.
...
## Common pitfalls
- Treating Gap And Go as a standalone signal instead of context.
