...
## How traders use it
- A gap that fills quickly can signal weak conviction.
- A gap that never fills may signal strong trend continuation.
- The gap fill level is often treated as a support or resistance reference.
...
## Practical checklist
- Define the time horizon for Gap Fill and the market context.
...
## Common pitfalls
- Treating Gap Fill as a standalone signal instead of context.
