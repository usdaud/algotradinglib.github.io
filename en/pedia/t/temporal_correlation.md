...
2. **[Quantlib](../q/quantlib.md)**: An [open](../o/open.md)-source library for [quantitative finance](../q/quantitative_finance.md) that includes tools for [time series analysis](../t/time_series_analysis.md), including temporal [correlation](../c/correlation.md). [Quantlib](https://www.quantlib.org/)
