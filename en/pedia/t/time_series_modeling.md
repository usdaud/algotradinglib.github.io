...
- **Pairs Trading**: Involves going long on one stock and shorting a statistically correlated stock pair to exploit relative price movements.
...
Numerai uses AI and machine learning models, including advanced time series models, to crowdsource trading algorithms.

### QuantConnect
[https://www.quantconnect.com](https://www.quantconnect.com)
QuantConnect provides a platform for algorithmic trading and research with tools for developing and backtesting time series models.

### Alpaca
[https://alpaca.markets](https://alpaca.markets)
Alpaca offers commission-free trading APIs that can integrate predictive models based on time series analysis.

### QuantInsti
[https://www.quantinsti.com](https://www.quantinsti.com)
QuantInsti provides education and training in algorithmic trading and includes courses on time series modeling.
