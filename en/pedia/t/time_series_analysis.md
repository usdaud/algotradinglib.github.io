...
- **Univariate Time Series**: Comprises observations of a single variable indexed by time.
...
- **Exponential Smoothing**: Gives more weight to the recent observations compared to older observations.
