...
- **Passivity**: The primary goal is to replicate the performance of an index rather than outperform it.
- **Diversification**: By replicating an entire index, tracker funds offer broad market exposure and diversify risk across various sectors and securities.
...
- **Transparency**: Since the holdings of the fund reflect the index, investors have a clear understanding of what securities are included in the portfolio.
