...
- **[Bloomberg](../b/bloomberg.md)**: Comprehensive provider for real-time and historical financial data, including [total return indices](../t/total_return_indices.md).
- **MSCI**: For extensive coverage of global indices, inclusive of [total return](../t/total_return.md) versions.
- **S&P Dow Jones Indices**: Offers a plethora of [total return indices](../t/total_return_indices.md), especially in the U.S. [market](../m/market.md).
