...
1. **[Market](../m/market.md) Data Engine**
 ...
 - **Example Providers:** [Bloomberg](../b/bloomberg.md) LP (bloomberglp.com), Thomson [Reuters](../r/reuters.md) (thomsonreuters.com).
...
2. **Strategy Implementation**
 ...
 - **Example Providers:** [QuantConnect](../q/quantconnect.md) (quantconnect.com), Algorithmia (algorithmia.com).
...
3. **[Order](../o/order.md) [Execution](../e/execution.md) Engine**
 ...
 - **Example Providers:** [Interactive Brokers](../i/interactive_brokers.md) (interactivebrokers.com), [TradeStation](../t/tradestation.md) (tradestation.com).
...
5. **[Backtesting](../b/backtesting.md) Module**
 ...
 - **Example Providers:** MetaTrader (metatrader.com), [TradeStation](../t/tradestation.md).
...
5. **[Sentiment Analysis](../s/sentiment_analysis.md)**
 ...
 - **Example Tools:** Dataminr (dataminr.com), [RavenPack](../r/ravenpack.md) (ravenpack.com).
...
2. **Software**
 ...
 - **Example Providers:** MetaTrader, [StockSharp](../s/stocksharp.md).
